...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 implements FlowCollector<Object> {
    ...
    public final class AnonymousClass1 extends ContinuationImpl {
        ...
        public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 read;
    ...
    public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2(r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 r8lambdaa6_tctqmksh3fk6hjgcbkuvde0, createInAppMessageEventSubscriber createinappmessageeventsubscriber) {
    ...
    public final Object emit(Object obj, ShortNewsContentCardView shortNewsContentCardView) {
        ...
        if (i2 == 0) {
            ...
            obj = anonymousClass1.write;
            flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 = anonymousClass1.read;
            ExtrasKt.RemoteActionCompatParcelizer(objInvoke);
        }
        if (!((Boolean) objInvoke).booleanValue()) {
            return createFromParcel.INSTANCE;
        }
        flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.serializer.IconCompatParcelizer = obj;
