...
public final class getRotaryInputOLwlOKwannotations implements r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM {
    ...
    public final Object invoke(Object obj) {
        ...
        try {
            ...
            return getDrawOLwlOKw.serializer(hideCurrentlyDisplayingInAppMessage.IconCompatParcelizer((CharSequence) stringValue, (CharSequence) stringValue2, false));
        } catch (Exception unused) {
            return getBringIntoViewOLwlOKwannotations.serializer;
        }
    }

    public getRotaryInputOLwlOKwannotations(List list, Value.RemoteActionCompatParcelizer remoteActionCompatParcelizer, Value.RemoteActionCompatParcelizer remoteActionCompatParcelizer2) {
        this.write = list;
