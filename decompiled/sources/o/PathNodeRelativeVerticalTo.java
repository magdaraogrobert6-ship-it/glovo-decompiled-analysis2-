...
public final class PathNodeRelativeVerticalTo implements getInAppMessageManager {
    private static final /* synthetic */ onCloseActionlambda1 descriptor;
    public static final PathNodeRelativeVerticalTo read;
    ...
    static {
        PathNodeRelativeVerticalTo pathNodeRelativeVerticalTo = new PathNodeRelativeVerticalTo();
        read = pathNodeRelativeVerticalTo;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("CLIENT_CHAT_NOTIFIES_ABOUT_MESSAGE_SENT", pathNodeRelativeVerticalTo, 3);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new PathNodeRelativeReflectiveCurveTo(i, strMediaMetadataCompat, strMediaMetadataCompat2, strMediaMetadataCompat3);
    }

    @Override // o.setGraphicModalMaxWidthDp
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        PathNodeRelativeReflectiveCurveTo pathNodeRelativeReflectiveCurveTo = (PathNodeRelativeReflectiveCurveTo) obj;
        pathNodeRelativeReflectiveCurveTo.getClass();
        onCloseActionlambda1 oncloseactionlambda1 = descriptor;
        ...
        getY2.read(pathNodeRelativeReflectiveCurveTo, defaultInAppMessageSlideupViewFactorySerializer, oncloseactionlambda1);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(oncloseactionlambda1, 2, pathNodeRelativeReflectiveCurveTo.bridgeMessageID);
