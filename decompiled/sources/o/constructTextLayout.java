...
public final /* synthetic */ class constructTextLayout implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 1;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    private static int read = 0;
    private static int serializer = 1;
    public static final constructTextLayout write;

    static {
        constructTextLayout constructtextlayout = new constructTextLayout();
        write = constructtextlayout;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("CLIENT_CRITICAL_CONTENT_RENDERED", constructtextlayout, 3);
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        updateOffsetsLDcG7Xg.IconCompatParcelizer(toggleableState, defaultInAppMessageSlideupViewFactorySerializer, r8lambda92m0p9sit5uf70mvjf4rwmruda);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 2, toggleableState.bridgeMessageId);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new ToggleableState(i, strMediaMetadataCompat, strMediaMetadataCompat2);
    }
}
