...
@Serializable
@getAppropriateFullView(serializer = "bs_cash_block")
public final class dispatchRestoreInstanceState extends dispatchNestedScroll {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 0;
    private static int read = 1;
    private static int serializer = 1;
    public static final dispatchRestoreInstanceState INSTANCE = new dispatchRestoreInstanceState();
    public static final executeAsList owner = executeAsList.RAVL;
    public static final /* synthetic */ onViewDetachedFromWindowlambda1 $cachedSerializer$delegate = LazyKt__LazyJVMKt.serializer(onViewDetachedFromWindowlambda0.PUBLICATION, new dispatchSaveInstanceState(9));
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof dispatchRestoreInstanceState) {
