...
public final /* synthetic */ class getPurchaseToken implements getInAppMessageManager {
    private static int IconCompatParcelizer = 1;
    private static int RemoteActionCompatParcelizer = 0;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    private static int read = 1;
    public static final getPurchaseToken serializer;
    private static int write;

    static {
        getPurchaseToken getpurchasetoken = new getPurchaseToken();
        serializer = getpurchasetoken;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.rider.state.breakrequest.data.entity.BreakRequest", getpurchasetoken, 2);
        oncloseactionlambda1.read(com.braze.models.inappmessage.InAppMessageBase.DURATION, false);
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        geteventtoken.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        String str = geteventtoken.duration;
        String str2 = geteventtoken.reason;
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new getEventToken(i2, strMediaMetadataCompat, str);
    }
}
