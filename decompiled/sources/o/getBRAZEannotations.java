...
public final class getBRAZEannotations implements r8lambdaQerpUnSf6AWv6hiw4VCR1aIOf0 {
    ...
    public final Object RemoteActionCompatParcelizer(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss) throws IOException {
        ...
        while (true) {
            ...
            if (b == 0) {
                return iOParser$Decoder.serializer();
            }
            ...
            if (s != 1) {
                if (s != 2) {
                    ...
                    CMMotionActivityConfidence cMMotionActivityConfidenceFindByValue = CMMotionActivityConfidence.findByValue(iMediaSessionCompatToken);
                    if (cMMotionActivityConfidenceFindByValue == null) {
                        MapboxVoiceInstructionsPlayer$Companion$$ExternalSyntheticLambda0.m(ThriftException.Kind.PROTOCOL_ERROR, c8$$ExternalSyntheticOutline0.m(iMediaSessionCompatToken, "Unexpected value for enum-type CMMotionActivityConfidence: "));
                        return null;
                    }
                    iOParser$Decoder.read = cMMotionActivityConfidenceFindByValue;
                } else {
                    getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
                }
            } else if (b == 3) {
                iOParser$Decoder.RemoteActionCompatParcelizer = Byte.valueOf(r8lambdat7xjd1d4humw0psb7whucfgonss.MediaMetadataCompat());
            } else {
                getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
            }
        }
    ...
    public final void read(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss, Object obj) throws IOException {
        getBRAZE_PUSH_DELIVERY_ENABLED_KEYannotations getbraze_push_delivery_enabled_keyannotations = (getBRAZE_PUSH_DELIVERY_ENABLED_KEYannotations) obj;
