...
public final /* synthetic */ class PopupLayoutCompanion implements getInAppMessageManager {
    private static int IconCompatParcelizer = 1;
    public static final PopupLayoutCompanion RemoteActionCompatParcelizer;
    ...
    static {
        PopupLayoutCompanion popupLayoutCompanion = new PopupLayoutCompanion();
        RemoteActionCompatParcelizer = popupLayoutCompanion;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.delivery.state.pudo.ItemComponent.Item.Extra", popupLayoutCompanion, 3);
        oncloseactionlambda1.read(com.deliveryhero.chatsdk.util.PushNotificationParserObj.TITLE_KEY, false);
        oncloseactionlambda1.read("price", false);
        oncloseactionlambda1.read("quantity", true);
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        setpopupcontentsizefhxjrpa.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        String str = setpopupcontentsizefhxjrpa.title;
        String str2 = setpopupcontentsizefhxjrpa.quantity;
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 0, str);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 1, setpopupcontentsizefhxjrpa.price);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new setPopupContentSizefhxjrPA(i2, strMediaMetadataCompat, strMediaMetadataCompat2, str);
    }
}
