...
public final class setAutomaticGeofenceRequestsEnabledandroid_sdk_base_release implements r8lambdaQerpUnSf6AWv6hiw4VCR1aIOf0 {
    ...
    public final Object RemoteActionCompatParcelizer(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss) throws IOException {
        ...
        while (true) {
            ...
            if (b == 0) {
                return iscontentcardsunreadvisualindicatorenabled.write();
            }
                ...
                if (s != 2) {
                    if (s != 3) {
                        if (s != 4) {
                            ...
                            iscontentcardsunreadvisualindicatorenabled.read = Byte.valueOf(r8lambdat7xjd1d4humw0psb7whucfgonss.MediaMetadataCompat());
                        } else {
                            getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
                        }
                    } else if (b == 3) {
                    ...
                    if (detectionTriggerFindByValue != null) {
                        iscontentcardsunreadvisualindicatorenabled.write = detectionTriggerFindByValue;
                    } else {
    ...
    public final void read(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss, Object obj) throws IOException {
        setApiKeyandroid_sdk_base_release setapikeyandroid_sdk_base_release = (setApiKeyandroid_sdk_base_release) obj;
        r8lambdat7xjd1d4humw0psb7whucfgonss.serializer(1, (byte) 10);
        Long l = setapikeyandroid_sdk_base_release.serializer;
        Byte b = setapikeyandroid_sdk_base_release.read;
        ...
        Byte b2 = setapikeyandroid_sdk_base_release.IconCompatParcelizer;
        if (b2 != null) {
            getBitmapFromCache.read((byte) 3, 3, r8lambdat7xjd1d4humw0psb7whucfgonss, b2);
        }
        if (b != null) {
