...
public final /* synthetic */ class accessattachIndentationFixSpan implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    public static final accessattachIndentationFixSpan RemoteActionCompatParcelizer;
    ...
    static {
        accessattachIndentationFixSpan accessattachindentationfixspan = new accessattachIndentationFixSpan();
        RemoteActionCompatParcelizer = accessattachindentationfixspan;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.customerchat.selfservice.data.bridge.HostMessage.HostAppProvidesChatConfig.Payload.Delivery", accessattachindentationfixspan, 7);
        oncloseactionlambda1.read("address", true);
        oncloseactionlambda1.read("customerNote", true);
        oncloseactionlambda1.read("entityNote", true);
        oncloseactionlambda1.read("name", true);
        oncloseactionlambda1.read("orderId", false);
        oncloseactionlambda1.read("phoneNumber", true);
        oncloseactionlambda1.read("totalAmountInCurrency", true);
    ...
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        ...
        setGraphicModalMaxWidthDp[] setgraphicmodalmaxwidthdpArr = {LazyKt__LazyJVMKt.read(beforeinappmessageviewclosed), LazyKt__LazyJVMKt.read(beforeinappmessageviewclosed), LazyKt__LazyJVMKt.read(beforeinappmessageviewclosed), LazyKt__LazyJVMKt.read(beforeinappmessageviewclosed), beforeinappmessageviewclosed, LazyKt__LazyJVMKt.read(beforeinappmessageviewclosed), LazyKt__LazyJVMKt.read(beforeinappmessageviewclosed)};
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        androidParagraph_androidKt.getClass();
        String str3 = androidParagraph_androidKt.name;
        String str4 = androidParagraph_androidKt.entityNote;
        String str5 = androidParagraph_androidKt.customerNote;
        String str6 = androidParagraph_androidKt.address;
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        ...
        if (defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda) || str6 != null) {
            defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda, 0, beforeInAppMessageViewClosed.RemoteActionCompatParcelizer, str6);
        }
        if (!defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda)) {
            ...
            String str7 = androidParagraph_androidKt.orderId;
            str = androidParagraph_androidKt.totalAmountInCurrency;
            str2 = androidParagraph_androidKt.phoneNumber;
            defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 4, str7);
        ...
        String str8 = androidParagraph_androidKt.orderId;
        str = androidParagraph_androidKt.totalAmountInCurrency;
        str2 = androidParagraph_androidKt.phoneNumber;
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 4, str8);
        if (defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda)) {
            defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda, 5, beforeInAppMessageViewClosed.RemoteActionCompatParcelizer, str2);
        } else {
            defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda, 5, beforeInAppMessageViewClosed.RemoteActionCompatParcelizer, str2);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new AndroidParagraph_androidKt(i4, str, str2, str3, str4, strMediaMetadataCompat, str5, str6);
    }
}
