...
public abstract class StretchOverscrollNode {
  ...
  0x006a: PHI (r8v2 int) = (r8v1 int), (r8v3 int) binds: [B:10:0x002c, B:22:0x0068] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof StretchOverscrollNode)) {
            return false;
        }
        StretchOverscrollNode stretchOverscrollNode = (StretchOverscrollNode) obj;
        if (stretchOverscrollNode.read != this.read) {
            return false;
        }
        int[] iArr = this.serializer;
        Object[] objArr = this.IconCompatParcelizer;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            if (obj2 == null) {
                                if (stretchOverscrollNode.serializer(i5) != null || !stretchOverscrollNode.RemoteActionCompatParcelizer(i5)) {
                                    return false;
                                }
                            } else if (!obj2.equals(stretchOverscrollNode.serializer(i5))) {
                                return false;
                            }
                        }
                        j >>= 8;
    ...
    public final Object serializer(int i) {
        ...
        if (iNumberOfTrailingZeros >= 0) {
            return this.IconCompatParcelizer[iNumberOfTrailingZeros];
        }
        return null;
    }
}
