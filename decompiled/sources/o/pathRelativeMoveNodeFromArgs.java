...
public final class pathRelativeMoveNodeFromArgs implements getInAppMessageManager {
    public static final pathRelativeMoveNodeFromArgs IconCompatParcelizer;
    ...
    static {
        pathRelativeMoveNodeFromArgs pathrelativemovenodefromargs = new pathRelativeMoveNodeFromArgs();
        IconCompatParcelizer = pathrelativemovenodefromargs;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("HELPCENTER_ASKS_FOR_SHUTDOWN", pathrelativemovenodefromargs, 3);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new resizeNodeData(i, strMediaMetadataCompat, strMediaMetadataCompat2, strMediaMetadataCompat3);
    }

    @Override // o.setGraphicModalMaxWidthDp
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        resizeNodeData resizenodedata = (resizeNodeData) obj;
        resizenodedata.getClass();
        onCloseActionlambda1 oncloseactionlambda1 = descriptor;
        ...
        getY2.read(resizenodedata, defaultInAppMessageSlideupViewFactorySerializer, oncloseactionlambda1);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(oncloseactionlambda1, 2, resizenodedata.bridgeMessageID);
