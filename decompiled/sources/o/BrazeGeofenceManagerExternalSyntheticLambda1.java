...
public abstract /* synthetic */ class BrazeGeofenceManagerExternalSyntheticLambda1 {
    public static final /* synthetic */ int[] read;

    static {
        int[] iArr = new int[HarshDrivingEntryType.values().length];
        try {
            iArr[HarshDrivingEntryType.ACCELERATING.ordinal()] = 1;
        ...
        try {
            iArr[HarshDrivingEntryType.TURN.ordinal()] = 3;
