...
public enum getChatID {
    ...
    public static getChatID byId(byte[] bArr) {
        for (getChatID getchatid : (getChatID[]) getChatID.class.getEnumConstants()) {
            if (Arrays.equals(getchatid.id, bArr)) {
                return getchatid;
            }
        }
        return null;
