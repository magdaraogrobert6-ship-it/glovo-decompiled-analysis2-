...
public final class getBeyondBoundsLayoutOLwlOKw implements r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM {
    ...
    public final Object invoke(Object obj) {
        ...
        for (Value value : valuesList2) {
            for (Value value2 : valuesList) {
                ...
                boolean zSerializer = NodeCoordinatorCompaniononCommitAffectingLayer1.serializer(value2, value);
                if (!zSerializer) {
                    if (zSerializer) {
    ...
    public getBeyondBoundsLayoutOLwlOKw(List list) {
        this.write = list;
    }
}
