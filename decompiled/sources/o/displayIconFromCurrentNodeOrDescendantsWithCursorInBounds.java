...
public abstract class displayIconFromCurrentNodeOrDescendantsWithCursorInBounds {
    public static String RemoteActionCompatParcelizer(String str, Object... objArr) {
        int length;
        int length2;
        int iIndexOf;
        String strWrite;
