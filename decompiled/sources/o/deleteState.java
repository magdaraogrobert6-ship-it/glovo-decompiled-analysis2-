...
public final /* synthetic */ class deleteState implements getInAppMessageManager {
    private static int IconCompatParcelizer = 1;
    private static int RemoteActionCompatParcelizer = 1;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    private static int read;
    public static final deleteState serializer;
    private static int write;

    static {
        deleteState deletestate = new deleteState();
        serializer = deletestate;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.push.messages.display.backgroud.PushDetailForGhostOrder", deletestate, 3);
        oncloseactionlambda1.read("deliveryId", true);
        oncloseactionlambda1.read("messageNewId", true);
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        endI endi = (endI) obj;
        endi.getClass();
        String str = endi.category;
        String str2 = endi.messageNewId;
        String str3 = endi.deliveryId;
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x004c A[SYNTHETIC] */
    @Override // o.setGraphicModalMaxWidthDp
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new endI(i4, str, str2, str3);
    }
}
