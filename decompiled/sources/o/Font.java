...
public final /* synthetic */ class Font implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 0;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    public static final Font read;
    ...
    static {
        Font font = new Font();
        read = font;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("countdown", font, 9);
        oncloseactionlambda1.read("id", false);
        oncloseactionlambda1.read(com.deliveryhero.chatsdk.util.PushNotificationParserObj.TITLE_KEY, false);
        oncloseactionlambda1.read("not_started_description", true);
        oncloseactionlambda1.read("started_description", true);
        oncloseactionlambda1.read("finished_description", true);
    ...
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        ...
        IconCompatParcelizer = i2 % androidx.compose.ui.graphics.Fields.SpotShadowColor;
        int i3 = i2 % 2;
        onViewDetachedFromWindowlambda1[] onviewdetachedfromwindowlambda1Arr = FontResourceLoader.$childSerializers;
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        fontResourceLoader.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        onViewDetachedFromWindowlambda1[] onviewdetachedfromwindowlambda1Arr = FontResourceLoader.$childSerializers;
        String str = fontResourceLoader.id;
        List list = fontResourceLoader.requiredSteps;
        getWindowTitle getwindowtitle = fontResourceLoader.timerStartAction;
        String str2 = fontResourceLoader.finishedDescription;
        String str3 = fontResourceLoader.startedDescription;
        String str4 = fontResourceLoader.notStartedDescription;
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 0, str);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 1, fontResourceLoader.title);
        ...
        defaultInAppMessageSlideupViewFactorySerializer.write(5, fontResourceLoader.timer, r8lambda92m0p9sit5uf70mvjf4rwmruda);
        if (defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda) || getwindowtitle != null) {
            defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda, 6, (setGraphicModalMaxWidthDp) onviewdetachedfromwindowlambda1Arr[6].MediaSessionCompatResultReceiverWrapper(), getwindowtitle);
        }
        ...
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 8, (setGraphicModalMaxWidthDp) onviewdetachedfromwindowlambda1Arr[8].MediaSessionCompatResultReceiverWrapper(), fontResourceLoader.trackingEvents);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        while (z) {
            ...
            switch (i4) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    getwindowtitle = (getWindowTitle) createinappmessageviewlambda1Serializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 6, (setGraphicModalMaxWidthDp) onviewdetachedfromwindowlambda1Arr[6].MediaSessionCompatResultReceiverWrapper(), getwindowtitle);
                    i2 |= 64;
                    break;
                case 7:
        ...
        return new FontResourceLoader(i2, strMediaMetadataCompat, strMediaMetadataCompat2, str, str2, str3, iIconCompatParcelizer, getwindowtitle, list2, list);
    }
}
