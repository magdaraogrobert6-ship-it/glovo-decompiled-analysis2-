...
public final class performPushDeliveryFlush implements r8lambdaQerpUnSf6AWv6hiw4VCR1aIOf0 {
    ...
    public final void read(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss, Object obj) {
        logPushCampaign logpushcampaign = (logPushCampaign) obj;
        r8lambdat7xjd1d4humw0psb7whucfgonss.serializer(1, (byte) 3);
        Byte b = logpushcampaign.read;
        ThriftBool thriftBool = logpushcampaign.MediaBrowserCompatMediaItem;
        ThriftBool thriftBool2 = logpushcampaign.RatingCompat;
        Byte b2 = logpushcampaign.MediaMetadataCompat;
        ThriftBool thriftBool3 = logpushcampaign.MediaDescriptionCompat;
        ThriftBool thriftBool4 = logpushcampaign.MediaSessionCompatQueueItem;
        af$$ExternalSyntheticOutline1.m((byte) 8, 2, r8lambdat7xjd1d4humw0psb7whucfgonss, b);
        r8lambdat7xjd1d4humw0psb7whucfgonss.read(logpushcampaign.write.value);
        r8lambdat7xjd1d4humw0psb7whucfgonss.serializer(3, (byte) 8);
        r8lambdat7xjd1d4humw0psb7whucfgonss.read(logpushcampaign.serializer.value);
        ThriftBool thriftBool5 = logpushcampaign.IconCompatParcelizer;
        if (thriftBool5 != null) {
