...
public enum PointerInteropFilterpointerInputFilter1dispatchToView2 implements clearOnDeviceChange {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_ENTITY_EXTRACTION_CLOSE(Constant.ERROR_GNSS_STATUS_INVALID),
    ...
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(Constant.ERROR_ACC_INVALID),
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(Constant.ERROR_ACC_GRAVITY_INVALID),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(Constant.ERROR_ACC_JUMP),
    ...
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(Constant.ERROR_GYRO_NO_DATA),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(Constant.ERROR_GYRO_LOW_FREQ),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(Constant.ERROR_GYRO_TIME_DIFF_LARGE),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(Constant.ERROR_GYRO_INVALID),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(215),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(Constant.ERROR_GYRO_JUMP),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(217),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(com.google.android.gms.dynamite.descriptors.com.google.android.gms.tagmanager.ModuleDescriptor.MODULE_VERSION),
    ...
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(LocationRequest.PRIORITY_MAG_POSITION),
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(302),
    INPUT_IMAGE_CONSTRUCTION(361),
    HANDLE_LEAKED(371),
    CAMERA_SOURCE(381),
    OPTIONAL_MODULE_IMAGE_LABELING(391),
    OPTIONAL_MODULE_LANGUAGE_ID(Constant.ERROR_ALGO_NULL_RESULT),
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(Constant.ERROR_ALGO_NOT_START),
    ...
    ON_DEVICE_FACE_MESH_LOAD(androidx.compose.ui.graphics.Fields.RotationY),
    ...
    PointerInteropFilterpointerInputFilter1dispatchToView2(int i) {
        this.zzeF = i;
    }
}
