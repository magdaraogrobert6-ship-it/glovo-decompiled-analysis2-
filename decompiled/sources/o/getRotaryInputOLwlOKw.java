...
public final class getRotaryInputOLwlOKw implements r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM {
    ...
    public final Object invoke(Object obj) {
        ...
        list.getClass();
        if (list.size() == 2) {
            return new getSoftKeyboardKeyInputOLwlOKw(list, this.serializer, this.RemoteActionCompatParcelizer);
        }
        getRectManager.write("Function should have exactly 2 params, but %d were given.", Integer.valueOf(list.size()));
        throw null;
    }

    public getRotaryInputOLwlOKw(Value.RemoteActionCompatParcelizer remoteActionCompatParcelizer, Value.RemoteActionCompatParcelizer remoteActionCompatParcelizer2) {
