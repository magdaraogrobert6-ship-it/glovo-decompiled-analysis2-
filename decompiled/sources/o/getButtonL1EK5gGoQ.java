...
public enum getButtonL1EK5gGoQ {
    ABORT_EVENT_AFTER("abort_event_after"),
    ACCOUNT(com.deliveryhero.fwf_cache.UtilKt.ACCOUNT_KEY),
    ACTIVITY("activity"),
    ACTIVATE("activate"),
    ...
    COUNTRY(com.deliveryhero.chatsdk.util.PushNotificationParserObj.COUNTRY_KEY),
    CSS_ID("css_id"),
    ...
    HTML(com.braze.models.Banner.HTML),
    ID("id"),
    ...
    POSITION("position"),
    PRICES("prices"),
    PRIORITY(RemoteMessageConst.Notification.PRIORITY),
    PRODUCT("product"),
    ...
    TITLE(com.deliveryhero.chatsdk.util.PushNotificationParserObj.TITLE_KEY),
