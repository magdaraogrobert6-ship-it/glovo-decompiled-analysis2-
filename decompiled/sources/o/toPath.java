...
public final class toPath implements getInAppMessageManager {
    public static final toPath RemoteActionCompatParcelizer;
    ...
    static {
        toPath topath = new toPath();
        RemoteActionCompatParcelizer = topath;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("HELPCENTER_ASKS_FOR_NEW_ACCESS_TOKEN", topath, 3);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new toNodes(i, strMediaMetadataCompat, strMediaMetadataCompat2, strMediaMetadataCompat3);
    }

    @Override // o.setGraphicModalMaxWidthDp
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        toNodes tonodes = (toNodes) obj;
        tonodes.getClass();
        onCloseActionlambda1 oncloseactionlambda1 = descriptor;
        ...
        getY2.read(tonodes, defaultInAppMessageSlideupViewFactorySerializer, oncloseactionlambda1);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(oncloseactionlambda1, 2, tonodes.bridgeMessageID);
