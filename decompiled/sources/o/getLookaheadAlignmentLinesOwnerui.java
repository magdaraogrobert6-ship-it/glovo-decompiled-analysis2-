...
public final class getLookaheadAlignmentLinesOwnerui extends getLookaheadCoordinatesAccessedDuringModifierPlacement {
    public getLookaheadAlignmentLinesOwnerui(Unsafe unsafe) {
        super(unsafe);
    }
