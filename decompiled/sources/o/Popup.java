...
public final /* synthetic */ class Popup implements getInAppMessageManager {
    private static int IconCompatParcelizer = 1;
    private static int RemoteActionCompatParcelizer = 0;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    public static final Popup read;
    ...
    static {
        ...
        read = popup;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.delivery.state.StateV3.AcceptData.PromoBonus", popup, 2);
    ...
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        ...
        if (i2 % 2 != 0) {
            onViewDetachedFromWindowlambda1[] onviewdetachedfromwindowlambda1Arr = PopupTestTag.$childSerializers;
            ...
            setgraphicmodalmaxwidthdpArr = new setGraphicModalMaxWidthDp[]{LazyKt__LazyJVMKt.read(beforeInAppMessageViewClosed.RemoteActionCompatParcelizer), PopupTestTag.$childSerializers[1].MediaSessionCompatResultReceiverWrapper()};
        }
        int i3 = write + 47;
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        popupTestTag.getClass();
        List list = popupTestTag.icons;
        String str = popupTestTag.text;
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        if (i3 % 2 != 0) {
            ...
            onviewdetachedfromwindowlambda1Arr = PopupTestTag.$childSerializers;
        ...
        return new PopupTestTag(list, i, str);
    }
}
