...
public final class getDx1 implements getInAppMessageManager {
    private static final /* synthetic */ onCloseActionlambda1 descriptor;
    public static final getDx1 serializer;

    @Override // o.getInAppMessageManager
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        beforeInAppMessageViewClosed beforeinappmessageviewclosed = beforeInAppMessageViewClosed.RemoteActionCompatParcelizer;
        return new setGraphicModalMaxWidthDp[]{beforeinappmessageviewclosed, beforeinappmessageviewclosed, beforeinappmessageviewclosed, PathNodeRelativeLineTo.write};
    }
    ...
    static {
        getDx1 getdx1 = new getDx1();
        serializer = getdx1;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("CLIENT_CHAT_NOTIFIES_ABOUT_CALL_BUTTON_CLICK", getdx1, 4);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        while (z) {
            ...
            if (i2 == -1) {
                ...
                getdx3 = (getDx3) createinappmessageviewlambda1Serializer.IconCompatParcelizer(oncloseactionlambda1, 3, PathNodeRelativeLineTo.write, getdx3);
                i |= 8;
            }
        }
        createinappmessageviewlambda1Serializer.write(oncloseactionlambda1);
        return new getDy1(i, strMediaMetadataCompat, strMediaMetadataCompat2, strMediaMetadataCompat3, getdx3);
    }
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        getY2.read(getdy1, defaultInAppMessageSlideupViewFactorySerializer, oncloseactionlambda1);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(oncloseactionlambda1, 2, getdy1.bridgeMessageID);
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(oncloseactionlambda1, 3, PathNodeRelativeLineTo.write, getdy1.payload);
