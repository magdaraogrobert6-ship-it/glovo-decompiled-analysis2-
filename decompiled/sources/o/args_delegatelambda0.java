...
public final class args_delegatelambda0 implements AddToCustomAttributeArrayStep {
    public static final args_delegatelambda0 serializer = new args_delegatelambda0();
    public final io.sentry.util.MediaMetadataCompat IconCompatParcelizer = new io.sentry.util.MediaMetadataCompat(new ActivityLifecycleIntegration$$ExternalSyntheticLambda1(10));
    ...
    public final parseEncodedActionToJsonandroid_sdk_ui_release clone() {
        return r8lambdaQeY5HgkCbIIscVGGsS6NtJurUQ.MediaSessionCompatResultReceiverWrapper();
    }
    ...
    public final io.sentry.logger.RemoteActionCompatParcelizer MediaDescriptionCompat() {
        return io.sentry.logger.RatingCompat.write;
    }
    ...
    public final getChildStepIteratorandroid_sdk_ui_release serializer(defaultCardHandling defaultcardhandling, handleCardClicklambda4 handlecardclicklambda4) {
        return secondArg_delegatelambda0.IconCompatParcelizer;
    }
    ...
    public final SentryOptions RemoteActionCompatParcelizer() {
        return (SentryOptions) this.IconCompatParcelizer.IconCompatParcelizer();
    }
