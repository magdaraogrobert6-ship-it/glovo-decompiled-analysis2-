...
public final class r8lambdaJjL4oPUfHNgx_ma2tJ0ZBEvFgLA implements r8lambdaQerpUnSf6AWv6hiw4VCR1aIOf0 {
    ...
    public final Object RemoteActionCompatParcelizer(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss) throws IOException {
        ...
        while (true) {
            ...
            switch (r8lambdau4n4uufm_ipqdhmmao_rti5aek0MediaBrowserCompatMediaItem.serializer) {
                ...
                case 4:
                    if (b == 12) {
                        r8lambdabirsljoagmyxhikohl5z5hht12q.read = (onActivityPausedlambda0) onActivityPausedlambda0.read.RemoteActionCompatParcelizer(r8lambdat7xjd1d4humw0psb7whucfgonss);
                    } else {
                        getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
                    }
                    break;
                case 5:
                    if (b == 12) {
                        r8lambdabirsljoagmyxhikohl5z5hht12q.MediaMetadataCompat = (registerOnApplicationlambda0) registerOnApplicationlambda0.write.RemoteActionCompatParcelizer(r8lambdat7xjd1d4humw0psb7whucfgonss);
                    } else {
                        getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
                    }
                    break;
                ...
                case 10:
                    if (b == 8) {
                        ...
                        r8lambdabirsljoagmyxhikohl5z5hht12q.MediaDescriptionCompat = thriftBoolFindByValue7;
                    } else {
                        getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
                    }
                    break;
    ...
    public final void read(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss, Object obj) {
        r8lambdaM7UaNzSECvCoNHXoN4wkPSK8w_I r8lambdam7uanzsecvconhxon4wkpsk8w_i = (r8lambdaM7UaNzSECvCoNHXoN4wkPSK8w_I) obj;
        r8lambdat7xjd1d4humw0psb7whucfgonss.serializer(1, (byte) 8);
        ThriftBool thriftBool = r8lambdam7uanzsecvconhxon4wkpsk8w_i.serializer;
        ThriftBool thriftBool2 = r8lambdam7uanzsecvconhxon4wkpsk8w_i.MediaSessionCompatToken;
        ThriftBool thriftBool3 = r8lambdam7uanzsecvconhxon4wkpsk8w_i.MediaMetadataCompat;
        ThriftBool thriftBool4 = r8lambdam7uanzsecvconhxon4wkpsk8w_i.MediaBrowserCompatMediaItem;
        ...
        r8lambdat7xjd1d4humw0psb7whucfgonss.read(r8lambdam7uanzsecvconhxon4wkpsk8w_i.RemoteActionCompatParcelizer.value);
        r8lambdat7xjd1d4humw0psb7whucfgonss.serializer(3, (byte) 8);
        r8lambdat7xjd1d4humw0psb7whucfgonss.read(r8lambdam7uanzsecvconhxon4wkpsk8w_i.read.value);
        ...
        r8lambdat7xjd1d4humw0psb7whucfgonss.RemoteActionCompatParcelizer(onactivitypausedlambda0.write.byteValue());
        ...
        ThriftBool thriftBool5 = r8lambdam7uanzsecvconhxon4wkpsk8w_i.RatingCompat;
        if (thriftBool5 != null) {
