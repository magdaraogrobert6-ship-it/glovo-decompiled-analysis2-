...
public final /* synthetic */ class isDelayedInitializationEnabled implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 1;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    private static int read = 0;
    public static final isDelayedInitializationEnabled serializer;
    private static int write = 1;

    static {
        isDelayedInitializationEnabled isdelayedinitializationenabled = new isDelayedInitializationEnabled();
        serializer = isdelayedinitializationenabled;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.startworking.data.stopworking.entity.VehicleRequest", isdelayedinitializationenabled, 2);
        oncloseactionlambda1.read("name", false);
        oncloseactionlambda1.read("bag_type", true);
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        isephemeraleventkeylambda0.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        String str = isephemeraleventkeylambda0.name;
        String str2 = isephemeraleventkeylambda0.bagType;
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new isEphemeralEventKeylambda0(i4, strMediaMetadataCompat, str);
    }
}
