...
public final class ComposeViewAdapterExternalSyntheticLambda9 extends Lambda implements r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM {
    ...
    public ComposeViewAdapterExternalSyntheticLambda9(androidx.constraintlayout.compose.Measurer2 measurer2, List list, LinkedHashMap linkedHashMap) {
        super(1);
        this.read = measurer2;
