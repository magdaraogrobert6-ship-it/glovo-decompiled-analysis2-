...
public final class setGenderlambda0 implements r8lambdaQerpUnSf6AWv6hiw4VCR1aIOf0 {
    ...
    public final void read(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss, Object obj) throws IOException {
        setEmailNotificationSubscriptionTypelambda0 setemailnotificationsubscriptiontypelambda0 = (setEmailNotificationSubscriptionTypelambda0) obj;
        r8lambdat7xjd1d4humw0psb7whucfgonss.serializer(1, (byte) 3);
        Byte b = setemailnotificationsubscriptiontypelambda0.serializer;
        ThriftBool thriftBool = setemailnotificationsubscriptiontypelambda0.PlaybackStateCompatCustomAction;
        ThriftBool thriftBool2 = setemailnotificationsubscriptiontypelambda0.RatingCompat;
        ThriftBool thriftBool3 = setemailnotificationsubscriptiontypelambda0.MediaDescriptionCompat;
        Long l = setemailnotificationsubscriptiontypelambda0.MediaMetadataCompat;
        Integer num = setemailnotificationsubscriptiontypelambda0.MediaSessionCompatQueueItem;
        af$$ExternalSyntheticOutline1.m((byte) 3, 2, r8lambdat7xjd1d4humw0psb7whucfgonss, b);
        af$$ExternalSyntheticOutline1.m((byte) 3, 3, r8lambdat7xjd1d4humw0psb7whucfgonss, setemailnotificationsubscriptiontypelambda0.RemoteActionCompatParcelizer);
        af$$ExternalSyntheticOutline1.m((byte) 3, 4, r8lambdat7xjd1d4humw0psb7whucfgonss, setemailnotificationsubscriptiontypelambda0.write);
        r8lambdat7xjd1d4humw0psb7whucfgonss.RemoteActionCompatParcelizer(setemailnotificationsubscriptiontypelambda0.IconCompatParcelizer.byteValue());
        ThriftBool thriftBool4 = setemailnotificationsubscriptiontypelambda0.MediaBrowserCompatMediaItem;
        if (thriftBool4 != null) {
