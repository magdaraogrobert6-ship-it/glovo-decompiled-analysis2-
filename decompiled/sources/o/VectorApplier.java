...
public final class VectorApplier implements getInAppMessageManager {
    private static final /* synthetic */ onCloseActionlambda1 descriptor;
    public static final VectorApplier write;

    @Override // o.getInAppMessageManager
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        beforeInAppMessageViewClosed beforeinappmessageviewclosed = beforeInAppMessageViewClosed.RemoteActionCompatParcelizer;
        return new setGraphicModalMaxWidthDp[]{beforeinappmessageviewclosed, beforeinappmessageviewclosed, beforeinappmessageviewclosed, onEndChanges.read};
    }
    ...
    static {
        VectorApplier vectorApplier = new VectorApplier();
        write = vectorApplier;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("HELPCENTER_INIT_STARTED", vectorApplier, 4);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        accessgetRootScaleYp accessgetrootscaleyp = null;
        while (z) {
            ...
            if (i2 == -1) {
                ...
                accessgetrootscaleyp = (accessgetRootScaleYp) createinappmessageviewlambda1Serializer.IconCompatParcelizer(oncloseactionlambda1, 3, onEndChanges.read, accessgetrootscaleyp);
                i |= 8;
            }
        }
        createinappmessageviewlambda1Serializer.write(oncloseactionlambda1);
        return new insertTopDown(i, strMediaMetadataCompat, strMediaMetadataCompat2, strMediaMetadataCompat3, accessgetrootscaleyp);
    }

    @Override // o.setGraphicModalMaxWidthDp
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        insertTopDown inserttopdown = (insertTopDown) obj;
        inserttopdown.getClass();
        onCloseActionlambda1 oncloseactionlambda1 = descriptor;
        ...
        getY2.read(inserttopdown, defaultInAppMessageSlideupViewFactorySerializer, oncloseactionlambda1);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(oncloseactionlambda1, 2, inserttopdown.bridgeMessageID);
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(oncloseactionlambda1, 3, onEndChanges.read, inserttopdown.payload);
