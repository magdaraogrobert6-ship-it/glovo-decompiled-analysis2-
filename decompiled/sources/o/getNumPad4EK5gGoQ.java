...
public abstract class getNumPad4EK5gGoQ extends AbstractCollection implements Serializable {
    ...
    public final Object[] toArray(Object[] objArr) {
        ...
        if (length < size) {
            ...
            if (objArrWrite != null) {
                return Arrays.copyOfRange(objArrWrite, read(), serializer(), objArr.getClass());
            }
            if (length != 0) {
