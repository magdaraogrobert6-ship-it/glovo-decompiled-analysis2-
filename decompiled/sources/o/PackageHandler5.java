...
public final /* synthetic */ class PackageHandler5 implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 1;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    private static int read = 0;
    public static final PackageHandler5 serializer;
    private static int write = 1;

    static {
        PackageHandler5 packageHandler5 = new PackageHandler5();
        serializer = packageHandler5;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.rider.state.searchshifts.api.entity.QuickSessionPickerData", packageHandler5, 2);
        oncloseactionlambda1.read("start_time", false);
        oncloseactionlambda1.read("end_times", true);
    ...
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        ...
        int i3 = i2 % 2;
        setGraphicModalMaxWidthDp[] setgraphicmodalmaxwidthdpArr = {beforeInAppMessageViewClosed.RemoteActionCompatParcelizer, PackageHandler3.$childSerializers[1].MediaSessionCompatResultReceiverWrapper()};
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        packageHandler3.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        onViewDetachedFromWindowlambda1[] onviewdetachedfromwindowlambda1Arr = PackageHandler3.$childSerializers;
        String str = packageHandler3.startTime;
        List list = packageHandler3.endTimes;
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new PackageHandler3(list, i4, strMediaMetadataCompat);
    }
}
