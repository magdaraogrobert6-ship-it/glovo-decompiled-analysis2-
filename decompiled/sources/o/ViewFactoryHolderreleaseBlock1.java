...
public final /* synthetic */ class ViewFactoryHolderreleaseBlock1 implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 0;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    private static int read = 1;
    private static int serializer = 1;
    public static final ViewFactoryHolderreleaseBlock1 write;

    static {
        ViewFactoryHolderreleaseBlock1 viewFactoryHolderreleaseBlock1 = new ViewFactoryHolderreleaseBlock1();
        write = viewFactoryHolderreleaseBlock1;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("message", viewFactoryHolderreleaseBlock1, 2);
        oncloseactionlambda1.read(com.deliveryhero.chatsdk.util.PushNotificationParserObj.TITLE_KEY, true);
        oncloseactionlambda1.read("image", true);
    ...
    /* JADX WARN: Code duplicated, block: B:10:0x003a A[DONT_INVERT] */
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        viewFactoryHolderregisterSaveStateProvider1.getClass();
        String str = viewFactoryHolderregisterSaveStateProvider1.image;
        String str2 = viewFactoryHolderregisterSaveStateProvider1.title;
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
    ...
    /* JADX WARN: Code duplicated, block: B:29:0x005e A[SYNTHETIC] */
    @Override // o.setGraphicModalMaxWidthDp
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        return new ViewFactoryHolderregisterSaveStateProvider1(i, str, str2);
    }
}
