...
public final /* synthetic */ class getBlackannotations implements getInAppMessageManager {
    public static final getBlackannotations IconCompatParcelizer;
    ...
    static {
        getBlackannotations getblackannotations = new getBlackannotations();
        IconCompatParcelizer = getblackannotations;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("on_the_way", getblackannotations, 2);
    ...
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        ...
        RemoteActionCompatParcelizer = i2 % androidx.compose.ui.graphics.Fields.SpotShadowColor;
        if (i2 % 2 != 0) {
            onViewDetachedFromWindowlambda1[] onviewdetachedfromwindowlambda1Arr = FontWeightCompanion.$childSerializers;
            ...
            setgraphicmodalmaxwidthdpArr = new setGraphicModalMaxWidthDp[]{beforeInAppMessageViewClosed.RemoteActionCompatParcelizer, FontWeightCompanion.$childSerializers[1].MediaSessionCompatResultReceiverWrapper()};
        }
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        fontWeightCompanion.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        onViewDetachedFromWindowlambda1[] onviewdetachedfromwindowlambda1Arr = FontWeightCompanion.$childSerializers;
        String str = fontWeightCompanion.title;
        List list = fontWeightCompanion.components;
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        if (i3 % 2 != 0) {
            ...
            onviewdetachedfromwindowlambda1Arr = FontWeightCompanion.$childSerializers;
        ...
        return new FontWeightCompanion(list, i, strMediaMetadataCompat);
    }
}
