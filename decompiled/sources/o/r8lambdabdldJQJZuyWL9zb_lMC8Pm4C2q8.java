...
public final class r8lambdabdldJQJZuyWL9zb_lMC8Pm4C2q8 implements r8lambdaQerpUnSf6AWv6hiw4VCR1aIOf0 {
        ...
        while (true) {
            ...
            if (s != 1) {
                if (s != 2) {
                    ...
                    iOParser$Decoder.read = Integer.valueOf(r8lambdat7xjd1d4humw0psb7whucfgonss.MediaSessionCompatToken());
                } else {
                    getLowestValueslo4al4.serializer(r8lambdat7xjd1d4humw0psb7whucfgonss, b);
                }
            } else if (b == 8) {
    ...
    public final void read(r8lambdaT7Xjd1d4hUmW0PSB7whuCfGONSs r8lambdat7xjd1d4humw0psb7whucfgonss, Object obj) throws IOException {
        onReceivelambda0 onreceivelambda0 = (onReceivelambda0) obj;
