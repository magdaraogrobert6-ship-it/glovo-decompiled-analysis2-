...
public abstract class getCenterRightF1C5BW0 {
    public static final Okio read;
    ...
    public static int read(byte[] bArr, int i, int i2) {
        ...
        if (i3 == 2) {
            return serializer(b, bArr[i], bArr[i + 1]);
        }
    ...
    static {
        read = (getUint64Low32annotations.IconCompatParcelizer && getUint64Low32annotations.write && !pickChildForForwardSearch.write()) ? new getBottomRightF1C5BW0(1) : new getBottomRightF1C5BW0(0);
    }
