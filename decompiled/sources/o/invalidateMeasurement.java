...
public abstract class invalidateMeasurement {
    ...
    public static final setNextChildPlaceOrderui IconCompatParcelizer(String str) {
        ...
        return setNextChildPlaceOrderui.IconCompatParcelizer(bArr);
    }
}
