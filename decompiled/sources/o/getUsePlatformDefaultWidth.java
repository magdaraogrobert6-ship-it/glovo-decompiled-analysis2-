...
public final /* synthetic */ class getUsePlatformDefaultWidth implements getInAppMessageManager {
    private static int IconCompatParcelizer = 0;
    private static int RemoteActionCompatParcelizer = 1;
    private static final r8lambda92M0P9sIT5Uf70mvjF4RwMruDA descriptor;
    public static final getUsePlatformDefaultWidth read;
    private static int serializer = 1;
    private static int write;

    static {
        getUsePlatformDefaultWidth getuseplatformdefaultwidth = new getUsePlatformDefaultWidth();
        read = getuseplatformdefaultwidth;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("com.roadrunner.delivery.state.model.Vendor.Location", getuseplatformdefaultwidth, 2);
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        dialogLayoutContent4.getClass();
        r8lambda92M0P9sIT5Uf70mvjF4RwMruDA r8lambda92m0p9sit5uf70mvjf4rwmruda = descriptor;
        DefaultInAppMessageSlideupViewFactory defaultInAppMessageSlideupViewFactorySerializer = defaultInAppMessageViewWrapperFactory.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 0, dialogLayoutContent4.latitude);
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 1, dialogLayoutContent4.longitude);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        DialogLayoutContent4 dialogLayoutContent4 = new DialogLayoutContent4(dRemoteActionCompatParcelizer, dRemoteActionCompatParcelizer2, i2);
        int i6 = RemoteActionCompatParcelizer + 39;
        IconCompatParcelizer = i6 % androidx.compose.ui.graphics.Fields.SpotShadowColor;
        if (i6 % 2 != 0) {
            int i7 = 15 / 0;
        }
        return dialogLayoutContent4;
    }
}
