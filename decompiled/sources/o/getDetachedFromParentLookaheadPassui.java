...
public final class getDetachedFromParentLookaheadPassui extends setGloballyPositionedObservers implements RandomAccess {
    public static final getDetachedFromParentLookaheadPassui serializer;
    ...
    static {
        getDetachedFromParentLookaheadPassui getdetachedfromparentlookaheadpassui = new getDetachedFromParentLookaheadPassui(0, new Object[0]);
        serializer = getdetachedfromparentlookaheadpassui;
        getdetachedfromparentlookaheadpassui.IconCompatParcelizer = false;
    }

    public getDetachedFromParentLookaheadPassui(int i, Object[] objArr) {
    ...
    public final LayoutNodeCompanionErrorMeasurePolicy1 read(int i) {
        if (i >= this.write) {
            return new getDetachedFromParentLookaheadPassui(this.write, Arrays.copyOf(this.RemoteActionCompatParcelizer, i));
        }
