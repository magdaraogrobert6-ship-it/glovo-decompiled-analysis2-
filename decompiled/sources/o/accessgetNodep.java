...
public final class accessgetNodep {
    public static GalileoNav[] IconCompatParcelizer(JSONArray jSONArray) {
    ...
    public static GpsNav[] read(JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        int i = 0;
        int i2 = 0;
    ...
    public static GlonassNav[] serializer(JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < jSONArray.length(); i++) {
            JSONObject jSONObjectOptJSONObject = jSONArray.optJSONObject(i);
    ...
    public static BdsNav[] write(JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        int i = 0;
        int i2 = 0;
        while (i2 < jSONArray.length()) {
