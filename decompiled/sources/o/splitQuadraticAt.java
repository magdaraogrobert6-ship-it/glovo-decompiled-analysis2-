...
@SuppressLint
public class splitQuadraticAt extends ImageView {
    public int RemoteActionCompatParcelizer;
    public int serializer;

    public splitQuadraticAt(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        this.serializer = Integer.MAX_VALUE;
        this.RemoteActionCompatParcelizer = Integer.MAX_VALUE;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, isQuadraticMonotonic.PreferenceImageView, 0, 0);
