...
public final class PathNodeVerticalTo implements getInAppMessageManager {
    private static final /* synthetic */ onCloseActionlambda1 descriptor;
    public static final PathNodeVerticalTo write;

    @Override // o.getInAppMessageManager
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        beforeInAppMessageViewClosed beforeinappmessageviewclosed = beforeInAppMessageViewClosed.RemoteActionCompatParcelizer;
        return new setGraphicModalMaxWidthDp[]{beforeinappmessageviewclosed, beforeinappmessageviewclosed, beforeinappmessageviewclosed, addPathNodes.write};
    }
    ...
    static {
        PathNodeVerticalTo pathNodeVerticalTo = new PathNodeVerticalTo();
        write = pathNodeVerticalTo;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("CLIENT_CHAT_NOTIFIES_ABOUT_QUICK_REPLY_SENT", pathNodeVerticalTo, 4);
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        pathMoveNodeFromArgs pathmovenodefromargs = null;
        while (z) {
            ...
            if (i2 == -1) {
                ...
                pathmovenodefromargs = (pathMoveNodeFromArgs) createinappmessageviewlambda1Serializer.IconCompatParcelizer(oncloseactionlambda1, 3, addPathNodes.write, pathmovenodefromargs);
                i |= 8;
            }
        }
        createinappmessageviewlambda1Serializer.write(oncloseactionlambda1);
        return new PathNodeKt(i, strMediaMetadataCompat, strMediaMetadataCompat2, strMediaMetadataCompat3, pathmovenodefromargs);
    }
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        getY2.read(pathNodeKt, defaultInAppMessageSlideupViewFactorySerializer, oncloseactionlambda1);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(oncloseactionlambda1, 2, pathNodeKt.bridgeMessageID);
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(oncloseactionlambda1, 3, addPathNodes.write, pathNodeKt.payload);
