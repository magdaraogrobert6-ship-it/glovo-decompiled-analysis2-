...
public final /* synthetic */ class removeItemDecoration implements getInAppMessageManager {
    ...
    static {
        ...
        IconCompatParcelizer = removeitemdecoration;
        onCloseActionlambda1 oncloseactionlambda1 = new onCloseActionlambda1("image", removeitemdecoration, 3);
        oncloseactionlambda1.read("source", false);
        oncloseactionlambda1.read("weight", true);
        oncloseactionlambda1.read("scaleType", false);
    ...
    public final setGraphicModalMaxWidthDp[] childSerializers() {
        ...
        if (i2 % 2 == 0) {
            ...
            setgraphicmodalmaxwidthdpArr = new setGraphicModalMaxWidthDp[]{beforeinappmessageviewclosed2, setgraphicmodalmaxwidthdp2, beforeinappmessageviewclosed2};
        }
    ...
    public final void serialize(DefaultInAppMessageViewWrapperFactory defaultInAppMessageViewWrapperFactory, Object obj) {
        ...
        if (!defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda)) {
            ...
            defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 2, requestchildonscreen.scaleType);
        ...
        defaultInAppMessageSlideupViewFactorySerializer.read(r8lambda92m0p9sit5uf70mvjf4rwmruda, 1, onClickedlambda0.serializer, f);
        defaultInAppMessageSlideupViewFactorySerializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 2, requestchildonscreen.scaleType);
        defaultInAppMessageSlideupViewFactorySerializer.IconCompatParcelizer(r8lambda92m0p9sit5uf70mvjf4rwmruda);
    }
    ...
    public final Object deserialize(DefaultInAppMessageModalViewFactoryCompanion defaultInAppMessageModalViewFactoryCompanion) {
        ...
        while (z) {
            ...
            if (i3 == -1) {
                ...
                f = (Float) createinappmessageviewlambda1Serializer.serializer(r8lambda92m0p9sit5uf70mvjf4rwmruda, 1, onClickedlambda0.serializer, f);
                i2 |= 2;
            }
        }
        createinappmessageviewlambda1Serializer.write(r8lambda92m0p9sit5uf70mvjf4rwmruda);
        requestChildOnScreen requestchildonscreen = new requestChildOnScreen(i2, strMediaMetadataCompat, f, strMediaMetadataCompat2);
        int i11 = write + 43;
        serializer = i11 % androidx.compose.ui.graphics.Fields.SpotShadowColor;
        if (i11 % 2 == 0) {
            return requestchildonscreen;
        }
        throw null;
    }
}
