...
public final class ColorSpaces {
    ...
    static {
        ...
        TransferParameters transferParameters2 = new TransferParameters(2.2d, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, 0.0d, 0.0d, i, defaultConstructorMarker);
        ...
        LinearSrgb = rgb2;
        Rgb rgb3 = new Rgb("scRGB-nl IEC 61966-2-2:2003", fArr, illuminant.getD65(), null, new getCanFocus(8), new getCanFocus(9), -0.799f, 2.399f, transferParameters, 2);
        ExtendedSrgb = rgb3;
        Rgb rgb4 = new Rgb("scRGB IEC 61966-2-2:2003", fArr, illuminant.getD65(), 1.0d, -0.5f, 7.499f, 3);
        LinearExtendedSrgb = rgb4;
        double d = 2.2222222222222223d;
        double d2 = 0.2222222222222222d;
        double d3 = 0.0d;
        double d4 = 0.0d;
        Rgb rgb5 = new Rgb("Rec. ITU-R BT.709-5", new float[]{0.64f, 0.33f, 0.3f, 0.6f, 0.15f, 0.06f}, illuminant.getD65(), new TransferParameters(d, 0.9099181073703367d, 0.09008189262966333d, d2, 0.081d, d3, d4, i, defaultConstructorMarker), 4);
        Bt709 = rgb5;
        Rgb rgb6 = new Rgb("Rec. ITU-R BT.2020-1", new float[]{0.708f, 0.292f, 0.17f, 0.797f, 0.131f, 0.046f}, illuminant.getD65(), new TransferParameters(d, 0.9096697898662786d, 0.09033021013372146d, d2, 0.08145d, d3, d4, i, defaultConstructorMarker), 5);
        Bt2020 = rgb6;
        ...
        Rgb rgb10 = new Rgb("SMPTE-C RGB", new float[]{0.63f, 0.34f, 0.31f, 0.595f, 0.155f, 0.07f}, illuminant.getD65(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, d5, d6, i2, defaultConstructorMarker2), 9);
        SmpteC = rgb10;
        Rgb rgb11 = new Rgb("Adobe RGB (1998)", new float[]{0.64f, 0.33f, 0.21f, 0.71f, 0.15f, 0.06f}, illuminant.getD65(), 2.2d, 0.0f, 1.0f, 10);
        AdobeRgb = rgb11;
        Rgb rgb12 = new Rgb("ROMM RGB ISO 22028-2:2013", new float[]{0.7347f, 0.2653f, 0.1596f, 0.8404f, 0.0366f, 1.0E-4f}, illuminant.getD50(), new TransferParameters(1.8d, 1.0d, 0.0d, 0.0625d, 0.031248d, d5, d6, i2, defaultConstructorMarker2), 11);
        ProPhotoRgb = rgb12;
        ...
        Unspecified = rgb15;
        Rgb rgb16 = new Rgb("Hybrid Log Gamma encoding", fArr3, illuminant.getD65(), null, new getCanFocus(10), new getCanFocus(11), 0.0f, 1.0f, transferParameters3, 17);
        Bt2020Hlg = rgb16;
        Rgb rgb17 = new Rgb("Perceptual Quantizer encoding", fArr3, illuminant.getD65(), null, new getCanFocus(12), new getCanFocus(13), 0.0f, 1.0f, transferParameters4, 18);
        Bt2020Pq = rgb17;
    ...
    public final ColorSpace match(float[] fArr, TransferParameters transferParameters) {
        for (ColorSpace colorSpace : ColorSpacesArray) {
            if (ColorModel.m1155equalsimpl0(colorSpace.m1164getModelxdoWZVw(), ColorModel.Companion.m1162getRgbxdoWZVw())) {
                ...
                colorSpaceAdapt$default.getClass();
    ...
    public final double transferSt2048Eotf$ui_graphics(TransferParameters transferParameters, double d) {
        ...
        double d3 = d * d2;
        double dPow = (Math.pow(d3, transferParameters.getC()) * transferParameters.getB()) + transferParameters.getA();
        return Math.pow((dPow >= 0.0d ? dPow : 0.0d) / ((Math.pow(d3, transferParameters.getC()) * transferParameters.getE()) + transferParameters.getD()), transferParameters.getF()) * d2;
    }
    ...
    public final double transferHlgEotf$ui_graphics(TransferParameters transferParameters, double d) {
        ...
        double f = transferParameters.getF();
        double d5 = a * d3;
        if (d5 <= 1.0d) {
            dExp = Math.pow(d5, b);
        } else {
            dExp = Math.exp((d3 - e) * c) + d4;
        }
        return (f + 1.0d) * d2 * dExp;
    }
    ...
    public final double transferSt2048Oetf$ui_graphics(TransferParameters transferParameters, double d) {
        ...
        return Math.pow(Math.max((Math.pow(d3, f) * d5) + d4, 0.0d) / ((Math.pow(d3, f) * (-transferParameters.getE())) + transferParameters.getB()), 1.0d / transferParameters.getC()) * d2;
    }
