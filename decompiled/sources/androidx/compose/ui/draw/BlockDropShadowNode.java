...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    public BlockDropShadowNode(Shape shape, r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM r8lambdaunavo3sxub_pc9xroryotnrlvsm) {
        this.shape = shape;
    ...
    private final DropShadowPainter obtainPainter() {
        if (!this.blockRead) {
            ...
            ObserverModifierNodeKt.observeReads(this, new r8lambdaRDpfSr94J4iEbcwX_KPqzPM8k0() { // from class: androidx.compose.ui.draw.BlockDropShadowNode.obtainPainter.1
        ...
        if (dropShadowPainter != null && shadow != null && Dp.m3678equalsimpl0(shadow.m1450getRadiusD9Ej5fM(), fMo44toDpu2uoSUM) && Dp.m3678equalsimpl0(shadow.m1451getSpreadD9Ej5fM(), fMo44toDpu2uoSUM2) && Color.m723equalsimpl0(shadow.m1448getColor0d7_KjU(), mo231getColor0d7_KjU())) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof BlockDropShadowNode)) {
            BlockDropShadowNode blockDropShadowNode = (BlockDropShadowNode) obj;
            if (getAlpha() == blockDropShadowNode.getAlpha()) {
                if (!((Boolean) removeNodeAtDepth.RemoteActionCompatParcelizer(getCieXyz.write(), 1803334089, -1803334089, getCieXyz.write(), getCieXyz.write(), new Object[]{this.shape, blockDropShadowNode.shape}, getCieXyz.write())).booleanValue() || this.block != blockDropShadowNode.block || getRadius() != blockDropShadowNode.getRadius() || getSpread() != blockDropShadowNode.getSpread() || !Offset.m474equalsimpl0(mo232getOffsetF1C5BW0(), blockDropShadowNode.mo232getOffsetF1C5BW0()) || !Color.m723equalsimpl0(mo231getColor0d7_KjU(), blockDropShadowNode.mo231getColor0d7_KjU())) {
                    return false;
                }
                return ((Boolean) removeNodeAtDepth.RemoteActionCompatParcelizer(getCieXyz.write(), 1803334089, -1803334089, getCieXyz.write(), getCieXyz.write(), new Object[]{getBrush(), blockDropShadowNode.getBrush()}, getCieXyz.write())).booleanValue() && BlendMode.m631equalsimpl0(mo230getBlendMode0nO6VwU(), blockDropShadowNode.mo230getBlendMode0nO6VwU());
            }
        }
        return false;
    }
