...
public final class VerticalScrollableClipShape implements Shape {
    public static final VerticalScrollableClipShape serializer = new VerticalScrollableClipShape();
    ...
    public final Outline mo24createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(-fMo42roundToPx0680j_4, 0.0f, Float.intBitsToFloat((int) (j >> 32)) + fMo42roundToPx0680j_4, Float.intBitsToFloat((int) (j & 4294967295L))));
    }
}
