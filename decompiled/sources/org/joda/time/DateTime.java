    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public DateTime withMaximumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e)) {
                    return new DateTime(getChronology().getZone().previousTransition(getMillis() + CarGwiSoFileConstant.CAR_GWI_SPECIFY_INTERVAL), getChronology());
                }
                throw e;
            }
        }
        ...
        public DateTime withMinimumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e)) {
                    return new DateTime(getChronology().getZone().nextTransition(getMillis() - CarGwiSoFileConstant.CAR_GWI_SPECIFY_INTERVAL), getChronology());
                }
                throw e;
            }
        }
