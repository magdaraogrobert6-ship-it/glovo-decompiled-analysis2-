...
public class DateTimeParserBucket {
    ...
    public static class SavedField implements Comparable<SavedField> {
        ...
        public long set(long j, boolean z) {
            ...
            long extended = str == null ? dateTimeField.setExtended(j, this.iValue) : dateTimeField.set(j, str, this.iLocale);
    ...
    public long doParseMillis(InternalParser internalParser, CharSequence charSequence) {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer(FormatUtils.createErrorMessage(charSequence.toString(), into));
        return 0L;
    }
