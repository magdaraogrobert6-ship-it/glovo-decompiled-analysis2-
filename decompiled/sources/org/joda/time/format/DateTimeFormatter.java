...
public class DateTimeFormatter {
    ...
    public int parseInto(ReadWritableInstant readWritableInstant, String str, int i) {
        ...
        if (readWritableInstant != null) {
            ...
            long offset = chronology.getZone().getOffset(millis);
            Chronology chronologySelectChronology = selectChronology(chronology);
            DateTimeParserBucket dateTimeParserBucket = new DateTimeParserBucket(millis + offset, chronologySelectChronology, this.iLocale, this.iPivotYear, i2);
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("Instant must not be null");
        return 0;
    }
