...
public class PeriodFormat {
    ...
    public static PeriodFormatter wordBased(Locale locale) {
        ...
        PeriodFormatter periodFormatterPutIfAbsent;
        ConcurrentMap<Locale, PeriodFormatter> concurrentMap = FORMATTERS;
        PeriodFormatter periodFormatter = concurrentMap.get(locale);
        return (periodFormatter != null || (periodFormatterPutIfAbsent = concurrentMap.putIfAbsent(locale, (periodFormatter = new PeriodFormatter((dynamicWordBased = new DynamicWordBased(buildWordBased(locale))), dynamicWordBased, locale, null)))) == null) ? periodFormatter : periodFormatterPutIfAbsent;
    }
