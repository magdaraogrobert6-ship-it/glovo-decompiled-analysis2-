...
public final class UnsupportedDateTimeField extends DateTimeField implements Serializable {
    ...
    /* JADX WARN: Code duplicated, block: B:13:0x0021 A[Catch: all -> 0x002d, TRY_LEAVE, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x0007, B:13:0x0021, B:7:0x0010, B:9:0x0018), top: B:19:0x0003 }] */
    public static UnsupportedDateTimeField getInstance(DateTimeFieldType dateTimeFieldType, DurationField durationField) {
        ...
        synchronized (UnsupportedDateTimeField.class) {
            ...
            if (map == null) {
                ...
                unsupportedDateTimeField = map.get(dateTimeFieldType);
