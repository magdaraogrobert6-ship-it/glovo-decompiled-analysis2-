...
public class FieldUtils {
    ...
    public static int getWrappedValue(int i, int i2, int i3) {
        if (i2 >= i3) {
            ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("MIN > MAX");
            return 0;
        }
        int i4 = (i3 - i2) + 1;
        int i5 = i - i2;
    ...
    public static long safeDivide(long j, long j2, RoundingMode roundingMode) {
        if (j == Long.MIN_VALUE && j2 == -1) {
            StringBuilder sbM = c8$$ExternalSyntheticOutline0.m(j, "Multiplication overflows a long: ", " / ");
            sbM.append(j2);
    ...
    public static int safeToInt(long j) {
        if (-2147483648L > j || j > 2147483647L) {
            throw new ArithmeticException(af$$ExternalSyntheticOutline0.m(j, "Value cannot fit in an int: "));
        }
        return (int) j;
    }
    ...
    public static long safeAdd(long j, long j2) {
        ...
        StringBuilder sbM = c8$$ExternalSyntheticOutline0.m(j, "The calculation caused an overflow: ", " + ");
        sbM.append(j2);
        throw new ArithmeticException(sbM.toString());
    }
    ...
    public static int safeAdd(int i, int i2) {
        ...
        throw new ArithmeticException(af$$ExternalSyntheticOutline0.m(i, "The calculation caused an overflow: ", i2, " + "));
    }
    ...
    public static int safeMultiply(int i, int i2) {
        ...
        if (j < -2147483648L || j > 2147483647L) {
            throw new ArithmeticException(af$$ExternalSyntheticOutline0.m(i, "Multiplication overflows an int: ", i2, " * "));
        }
        return (int) j;
    }
