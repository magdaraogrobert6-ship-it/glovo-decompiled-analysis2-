...
public abstract class AbstractPartialFieldProperty {
    ...
    public int compareTo(ReadableInstant readableInstant) {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("The instant must not be null");
        return 0;
    }
    ...
    public int hashCode() {
        int i = get();
        return getReadablePartial().getChronology().hashCode() + ((getFieldType().hashCode() + ((i + 247) * 13)) * 13);
    }
