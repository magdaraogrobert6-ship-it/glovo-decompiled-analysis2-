...
public final class GregorianChronology extends BasicGJChronology {
        ...
        try {
            ...
            synchronized (gregorianChronologyArr) {
                ...
                if (gregorianChronology == null) {
                    ...
                    gregorianChronology = dateTimeZone == dateTimeZone2 ? new GregorianChronology(null, null, i) : new GregorianChronology(ZonedChronology.getInstance(getInstance(dateTimeZone2, i), dateTimeZone), null, i);
    ...
    public long calculateFirstDayOfYearMillis(int i) {
        ...
        return ((((long) i) * 365) + ((long) (i2 - DAYS_0000_TO_1970))) * CarGwiSoFileConstant.CAR_GWI_SPECIFY_INTERVAL;
    }
