...
public abstract class AbstractInterval implements ReadableInterval {
    ...
    public int hashCode() {
        ...
        return getChronology().hashCode() + ((((((int) (startMillis ^ (startMillis >>> 32))) + 3007) * 31) + ((int) (endMillis ^ (endMillis >>> 32)))) * 31);
    }
    ...
    public void checkInterval(long j, long j2) {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("The end instant must be greater than the start instant");
    }
