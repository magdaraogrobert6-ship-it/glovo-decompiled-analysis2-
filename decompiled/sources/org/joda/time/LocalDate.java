...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public DateTime toDateTime(LocalTime localTime, DateTimeZone dateTimeZone) {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("The chronology of the time does not match");
        return null;
    }
    ...
    public LocalDateTime toLocalDateTime(LocalTime localTime) {
        if (localTime != null) {
            if (getChronology() == localTime.getChronology()) {
                ...
                return new LocalDateTime(localTime.getLocalMillis() + localMillis, getChronology());
            }
            ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("The chronology of the time does not match");
            return null;
        }
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("The time must not be null");
        return null;
    }
