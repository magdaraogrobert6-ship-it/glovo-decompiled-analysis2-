...
public final class PhotoIdPreviewFragment extends BaseInjectionDialogFragment {
    ...
    public PhotoIdPreviewFragment() {
        PhotoIdPreviewFragment$$ExternalSyntheticLambda1 photoIdPreviewFragment$$ExternalSyntheticLambda1 = new PhotoIdPreviewFragment$$ExternalSyntheticLambda1(this, 0);
        onViewDetachedFromWindowlambda1 onviewdetachedfromwindowlambda1Serializer = LazyKt__LazyJVMKt.serializer(onViewDetachedFromWindowlambda0.NONE, new r8lambdaFCGRAg6MbUuOq_lpWWSN4eMkQA(24, new r8lambdaFCGRAg6MbUuOq_lpWWSN4eMkQA(23, this)));
        this.getNavigationEventDispatcher = new ComponentRegistry$Builder(displayInAppMessagelambda1.serializer(_set_registeredPushToken_lambda1.class), new r8lambdaF9FA59YZVmE5QVJf1DDc5EcXdk(onviewdetachedfromwindowlambda1Serializer, 12), photoIdPreviewFragment$$ExternalSyntheticLambda1, new r8lambdaF9FA59YZVmE5QVJf1DDc5EcXdk(onviewdetachedfromwindowlambda1Serializer, 13));
    }

    @Override // androidx.fragment.app.DialogFragment, androidx.fragment.app.Fragment
    public final void onCreate(Bundle bundle) {
        int i = 2 % 2;
        int i2 = onConfigurationChanged + 93;
        getOnBackPressedDispatcher = i2 % Fields.SpotShadowColor;
        int i3 = i2 % 2;
        super.onCreate(bundle);
        read(0, R.style.Theme_RoadRunner_Dialog_FullScreen);
        int i4 = getOnBackPressedDispatcher + 41;
