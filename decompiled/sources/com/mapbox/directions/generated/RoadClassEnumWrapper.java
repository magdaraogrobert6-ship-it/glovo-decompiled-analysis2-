...
public final class RoadClassEnumWrapper extends Table {
    ...
    public static final class Companion {
        ...
        public final int createRoadClassEnumWrapper(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, boolean z, byte b, int i) {
            throw null;
        }

        public final int endRoadClassEnumWrapper(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startRoadClassEnumWrapper(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final RoadClassEnumWrapper getRootAsRoadClassEnumWrapper(ByteBuffer byteBuffer, RoadClassEnumWrapper roadClassEnumWrapper) {
            byteBuffer.getClass();
            roadClassEnumWrapper.getClass();
            return roadClassEnumWrapper.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final RoadClassEnumWrapper getRootAsRoadClassEnumWrapper(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsRoadClassEnumWrapper(byteBuffer, new RoadClassEnumWrapper());
        }
    }
    ...
    public final RoadClassEnumWrapper __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
