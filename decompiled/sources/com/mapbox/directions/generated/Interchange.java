...
public final class Interchange extends Table {
    ...
    public final byte m4616unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
    ...
    public static final class Companion {
        ...
        public final int createInterchange(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, int i, int i2) {
            throw null;
        }

        /* JADX INFO: renamed from: createUnrecognizedPropertiesVector-VU-fvBY, reason: not valid java name */
        public final int m4617createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endInterchange(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startInterchange(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final Interchange getRootAsInterchange(ByteBuffer byteBuffer, Interchange interchange) {
            byteBuffer.getClass();
            interchange.getClass();
            return interchange.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final Interchange getRootAsInterchange(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsInterchange(byteBuffer, new Interchange());
        }
    }
    ...
    public final Interchange __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
