...
public final class TollCollection extends Table {
    ...
    public static final class Companion {
        ...
        public final int createTollCollection(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, Byte b, int i, int i2) {
            throw null;
        }

        /* JADX INFO: renamed from: createUnrecognizedPropertiesVector-VU-fvBY, reason: not valid java name */
        public final int m4664createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endTollCollection(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startTollCollection(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final TollCollection getRootAsTollCollection(ByteBuffer byteBuffer, TollCollection tollCollection) {
            byteBuffer.getClass();
            tollCollection.getClass();
            return tollCollection.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final TollCollection getRootAsTollCollection(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsTollCollection(byteBuffer, new TollCollection());
        }
    }
    ...
    public final byte m4663unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(8);
        if (i__offset != 0) {
    ...
    public final TollCollection __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public final TollCollectionType getType() {
        Byte b = get_type$dash_native_release();
        if (b == null) {
            return null;
        }
        return TollCollectionType.Companion.fromByteOrThrow(b.byteValue());
    }
