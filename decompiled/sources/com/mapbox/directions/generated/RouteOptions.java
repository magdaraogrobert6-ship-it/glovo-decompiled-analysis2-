...
public final class RouteOptions extends Table {
    ...
    public final byte m4655unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(4);
        if (i__offset != 0) {
    ...
    public static final class Companion {
        ...
        public final int createRouteOptions(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, int i) {
            throw null;
        }

        /* JADX INFO: renamed from: createUnrecognizedPropertiesVector-VU-fvBY, reason: not valid java name */
        public final int m4656createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endRouteOptions(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startRouteOptions(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final RouteOptions getRootAsRouteOptions(ByteBuffer byteBuffer, RouteOptions routeOptions) {
            byteBuffer.getClass();
            routeOptions.getClass();
            return routeOptions.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final RouteOptions getRootAsRouteOptions(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsRouteOptions(byteBuffer, new RouteOptions());
        }
    }
    ...
    public final RouteOptions __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
