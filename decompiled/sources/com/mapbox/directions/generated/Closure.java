...
public final class Closure extends Table {
    public static final Companion Companion = new Companion(null);

    public final int getGeometryIndexStart() {
    ...
    public static final class Companion {
        ...
        public final int createClosure(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, boolean z, int i, int i2, int i3) {
            throw null;
        }

        /* JADX INFO: renamed from: createUnrecognizedPropertiesVector-VU-fvBY, reason: not valid java name */
        public final int m4598createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endClosure(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startClosure(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final Closure getRootAsClosure(ByteBuffer byteBuffer, Closure closure) {
            byteBuffer.getClass();
            closure.getClass();
            return closure.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final Closure getRootAsClosure(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsClosure(byteBuffer, new Closure());
        }
    }

    public final int getGeometryIndexEnd() {
    ...
    public final byte m4597unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(10);
        if (i__offset != 0) {
    ...
    public final Closure __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
