...
public final class MergingArea extends Table {
    ...
    public final byte m4641unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
    ...
    public static final class Companion {
        ...
        public final int createMergingArea(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, Byte b, int i) {
            throw null;
        }

        /* JADX INFO: renamed from: createUnrecognizedPropertiesVector-VU-fvBY, reason: not valid java name */
        public final int m4642createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endMergingArea(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startMergingArea(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final MergingArea getRootAsMergingArea(ByteBuffer byteBuffer, MergingArea mergingArea) {
            byteBuffer.getClass();
            mergingArea.getClass();
            return mergingArea.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final MergingArea getRootAsMergingArea(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsMergingArea(byteBuffer, new MergingArea());
        }
    }
    ...
    public final MergingArea __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public final MergingAreaType getType() {
        Byte b = get_type$dash_native_release();
        if (b == null) {
            return null;
        }
        return MergingAreaType.Companion.fromByteOrThrow(b.byteValue());
    }
}
