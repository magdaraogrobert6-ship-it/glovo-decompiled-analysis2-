...
public final class BannerText extends Table {
    ...
    public static final class Companion {
        ...
        public final void addDegrees(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, double d) {
            throw null;
        }
        ...
        public final int createBannerText(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, int i, int i2, Byte b, Byte b2, Double d, Byte b3, int i3) {
            throw null;
        }
        ...
        public final int m4594createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endBannerText(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startBannerText(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final BannerText getRootAsBannerText(ByteBuffer byteBuffer, BannerText bannerText) {
            byteBuffer.getClass();
            bannerText.getClass();
            return bannerText.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final BannerText getRootAsBannerText(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsBannerText(byteBuffer, new BannerText());
        }
    }
    ...
    public final byte m4593unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(16);
        if (i__offset != 0) {
    ...
    public final BannerText __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
