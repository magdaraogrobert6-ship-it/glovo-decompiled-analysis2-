...
public final class TollCost extends Table {
    ...
    public static final class Companion {
        ...
        public final void addCurrency(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, int i) {
            throw null;
        }
        ...
        public final int createTollCost(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, boolean z, int i, int i2, int i3) {
            throw null;
        }

        /* JADX INFO: renamed from: createUnrecognizedPropertiesVector-VU-fvBY, reason: not valid java name */
        public final int m4666createUnrecognizedPropertiesVectorVUfvBY(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt, byte[] bArr) {
            throw null;
        }

        public final int endTollCost(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }

        public final void startTollCost(AndroidCompositionLocals_androidKt androidCompositionLocals_androidKt) {
            throw null;
        }
        ...
        public final TollCost getRootAsTollCost(ByteBuffer byteBuffer, TollCost tollCost) {
            byteBuffer.getClass();
            tollCost.getClass();
            return tollCost.__assign(byteBuffer.position() + af$$ExternalSyntheticOutline0.m(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        private Companion() {
        }

        public final TollCost getRootAsTollCost(ByteBuffer byteBuffer) {
            byteBuffer.getClass();
            return getRootAsTollCost(byteBuffer, new TollCost());
        }
    }

    public final ByteBuffer getCurrencyAsByteBuffer() {
    ...
    public final PaymentMethods getPaymentMethods() {
        return paymentMethods(new PaymentMethods());
    }
    ...
    public final byte m4665unrecognizedPropertiesWa3L5BU(int i) {
        int i__offset = __offset(10);
        if (i__offset != 0) {
    ...
    public final TollCost __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public final ByteBuffer currencyInByteBuffer(ByteBuffer byteBuffer) {
        byteBuffer.getClass();
    ...
    public final PaymentMethods paymentMethods(PaymentMethods paymentMethods) {
        ...
        byteBuffer.getClass();
        return paymentMethods.__assign(i__indirect, byteBuffer);
    }
