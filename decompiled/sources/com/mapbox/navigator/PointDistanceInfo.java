...
public class PointDistanceInfo implements Serializable {
    ...
    public PointDistanceInfo(double d, Position position) {
        this.distance = d;
    ...
    public boolean equals(Object obj) {
        ...
        return PartialEq.compare(this.distance, pointDistanceInfo.distance) && Objects.equals(this.position, pointDistanceInfo.position);
    }
}
