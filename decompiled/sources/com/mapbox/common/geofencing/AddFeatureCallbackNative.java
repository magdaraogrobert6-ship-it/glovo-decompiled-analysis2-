...
final class AddFeatureCallbackNative implements AddFeatureCallback {
    ...
    @Override // com.mapbox.common.geofencing.AddFeatureCallback
    ...
    public static final class Companion {
        ...
        public final void cleanNativePeer(long j) {
            AddFeatureCallbackNative.cleanNativePeer(j);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final void nativeSelfRegister() {
            AddFeatureCallbackNative.nativeSelfRegister();
        }
    ...
    private AddFeatureCallbackNative(long j) {
        this.peer = j;
        CleanerService.register(this, new GeofencingUtils$$ExternalSyntheticLambda0(j, 1));
    }
}
