...
final class RemoveFeatureCallbackNative implements RemoveFeatureCallback {
    ...
    public static final class Companion {
        ...
        public final void cleanNativePeer(long j) {
            RemoveFeatureCallbackNative.cleanNativePeer(j);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final void nativeSelfRegister() {
            RemoveFeatureCallbackNative.nativeSelfRegister();
        }
    ...
    private RemoveFeatureCallbackNative(long j) {
        this.peer = j;
        CleanerService.register(this, new GeofencingUtils$$ExternalSyntheticLambda0(j, 8));
    }
}
