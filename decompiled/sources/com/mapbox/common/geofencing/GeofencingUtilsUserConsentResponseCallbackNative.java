...
final class GeofencingUtilsUserConsentResponseCallbackNative implements GeofencingUtilsUserConsentResponseCallback {
    ...
    public static final class Companion {
        ...
        public final void cleanNativePeer(long j) {
            GeofencingUtilsUserConsentResponseCallbackNative.cleanNativePeer(j);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final void nativeSelfRegister() {
            GeofencingUtilsUserConsentResponseCallbackNative.nativeSelfRegister();
        }
    ...
    private GeofencingUtilsUserConsentResponseCallbackNative(long j) {
        this.peer = j;
        CleanerService.register(this, new GeofencingUtils$$ExternalSyntheticLambda0(j, 5));
    }
}
