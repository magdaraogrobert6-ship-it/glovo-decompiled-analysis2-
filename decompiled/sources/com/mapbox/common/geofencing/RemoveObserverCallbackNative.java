...
final class RemoveObserverCallbackNative implements RemoveObserverCallback {
    ...
    @Override // com.mapbox.common.geofencing.RemoveObserverCallback
    ...
    public static final class Companion {
        ...
        public final void cleanNativePeer(long j) {
            RemoveObserverCallbackNative.cleanNativePeer(j);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final void nativeSelfRegister() {
            RemoveObserverCallbackNative.nativeSelfRegister();
        }
    ...
    private RemoveObserverCallbackNative(long j) {
        this.peer = j;
        CleanerService.register(this, new GeofencingUtils$$ExternalSyntheticLambda0(j, 9));
    }
}
