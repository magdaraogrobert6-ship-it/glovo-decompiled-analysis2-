...
final class AddObserverCallbackNative implements AddObserverCallback {
    ...
    @Override // com.mapbox.common.geofencing.AddObserverCallback
    ...
    public static final class Companion {
        ...
        public final void cleanNativePeer(long j) {
            AddObserverCallbackNative.cleanNativePeer(j);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final void nativeSelfRegister() {
            AddObserverCallbackNative.nativeSelfRegister();
        }
    ...
    private AddObserverCallbackNative(long j) {
        this.peer = j;
        CleanerService.register(this, new GeofencingUtils$$ExternalSyntheticLambda0(j, 2));
    }
}
