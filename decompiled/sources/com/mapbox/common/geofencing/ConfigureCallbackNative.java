...
final class ConfigureCallbackNative implements ConfigureCallback {
    ...
    public static final class Companion {
        ...
        public final void nativeSelfRegister() {
            ConfigureCallbackNative.nativeSelfRegister();
        }
    ...
    private ConfigureCallbackNative(long j) {
        this.peer = j;
        CleanerService.register(this, new GeofencingUtils$$ExternalSyntheticLambda0(j, 4));
    }
}
