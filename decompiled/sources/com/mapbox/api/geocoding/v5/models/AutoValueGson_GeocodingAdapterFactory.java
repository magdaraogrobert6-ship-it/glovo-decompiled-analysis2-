...
final class AutoValueGson_GeocodingAdapterFactory extends GeocodingAdapterFactory {
    ...
    public final TypeAdapter create(Gson gson, TypeToken typeToken) {
        ...
        if (AutoValue_V6ForwardGeocodingRequestOptions.class.isAssignableFrom(rawType)) {
            return AutoValue_V6ForwardGeocodingRequestOptions.typeAdapter(gson);
        }
        if (AutoValue_V6ReverseGeocodingRequestOptions.class.isAssignableFrom(rawType)) {
            return AutoValue_V6ReverseGeocodingRequestOptions.typeAdapter(gson);
        }
