    ...
    public static final class GsonTypeAdapter extends TypeAdapter<MapboxStreetsV8> {
        ...
        public void write(JsonWriter jsonWriter, MapboxStreetsV8 mapboxStreetsV8) throws IOException {
            ...
            if (mapboxStreetsV8.roadClass() == null) {
                ...
                adapter.write(jsonWriter, mapboxStreetsV8.roadClass());
            }
        ...
        public MapboxStreetsV8 read2(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_MapboxStreetsV8(linkedHashMap, str);
        }
    }

    public AutoValue_MapboxStreetsV8(final Map<String, SerializableJsonElement> map, final String str) {
        new MapboxStreetsV8(map, str) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_MapboxStreetsV8
            ...
            public boolean equals(Object obj) {
                ...
                } else if (!map2.equals(mapboxStreetsV8.unrecognized())) {
                    return false;
                }
            ...
            public String toString() {
                StringBuilder sb = new StringBuilder("MapboxStreetsV8{unrecognized=");
                sb.append(this.unrecognized);
                sb.append(", roadClass=");
                return ff$$ExternalSyntheticOutline0.m(sb, this.roadClass, "}");
            }
