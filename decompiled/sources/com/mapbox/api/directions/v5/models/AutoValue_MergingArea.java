    ...
    public static final class GsonTypeAdapter extends TypeAdapter<MergingArea> {
        ...
        public void write(JsonWriter jsonWriter, MergingArea mergingArea) throws IOException {
            ...
            if (mergingArea.unrecognized() != null) {
                for (Map.Entry<String, SerializableJsonElement> entry : mergingArea.unrecognized().entrySet()) {
            ...
            if (mergingArea.type() == null) {
                ...
                adapter.write(jsonWriter, mergingArea.type());
            }
        ...
        public MergingArea read2(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_MergingArea(linkedHashMap, str);
        }
    }

    public AutoValue_MergingArea(final Map<String, SerializableJsonElement> map, final String str) {
        new MergingArea(map, str) { // from class: com.mapbox.api.directions.v5.models.$AutoValue_MergingArea
            ...
            public boolean equals(Object obj) {
                ...
                } else if (!map2.equals(mergingArea.unrecognized())) {
                    return false;
                }
                ...
                } else if (!str2.equals(mergingArea.type())) {
                    return false;
                }
                return true;
            }
