...
public final class LongClickInteraction<T extends FeaturesetFeature<?>> extends MapInteraction {
    ...
    public static final class Companion {
        ...
        public final MapInteraction featureset(final String str, final String str2, Value value, Double d, r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 r8lambdaa6_tctqmksh3fk6hjgcbkuvde0) {
            ...
            return new LongClickInteraction(new FeaturesetDescriptor(str, str2, null), value, d, r8lambdaa6_tctqmksh3fk6hjgcbkuvde0, new r8lambdafjQ9B8d5OSR_i2BAJDXqNW6RNrY() { // from class: com.mapbox.maps.LongClickInteraction$Companion$featureset$1
        ...
        public final MapInteraction layer(final String str, Value value, Double d, r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 r8lambdaa6_tctqmksh3fk6hjgcbkuvde0) {
            str.getClass();
            r8lambdaa6_tctqmksh3fk6hjgcbkuvde0.getClass();
            return new LongClickInteraction(new FeaturesetDescriptor(null, null, str), value, d, r8lambdaa6_tctqmksh3fk6hjgcbkuvde0, new r8lambdafjQ9B8d5OSR_i2BAJDXqNW6RNrY() { // from class: com.mapbox.maps.LongClickInteraction$Companion$layer$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(3);
                }
        ...
        public final LongClickInteraction map(r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM r8lambdaunavo3sxub_pc9xroryotnrlvsm) {
            r8lambdaunavo3sxub_pc9xroryotnrlvsm.getClass();
            return new LongClickInteraction(r8lambdaunavo3sxub_pc9xroryotnrlvsm, null);
        }
    ...
    public static final LongClickInteraction map(r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM r8lambdaunavo3sxub_pc9xroryotnrlvsm) {
        return Companion.map(r8lambdaunavo3sxub_pc9xroryotnrlvsm);
    }

    public LongClickInteraction(FeaturesetDescriptor featuresetDescriptor, Value value, Double d, final r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 r8lambdaa6_tctqmksh3fk6hjgcbkuvde0, final r8lambdafjQ9B8d5OSR_i2BAJDXqNW6RNrY r8lambdafjq9b8d5osr_i2bajdxqnw6rnry) {
    ...
    public /* synthetic */ LongClickInteraction(FeaturesetDescriptor featuresetDescriptor, Value value, Double d, r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 r8lambdaa6_tctqmksh3fk6hjgcbkuvde0, r8lambdafjQ9B8d5OSR_i2BAJDXqNW6RNrY r8lambdafjq9b8d5osr_i2bajdxqnw6rnry, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public /* synthetic */ LongClickInteraction(r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM r8lambdaunavo3sxub_pc9xroryotnrlvsm, DefaultConstructorMarker defaultConstructorMarker) {
        this(r8lambdaunavo3sxub_pc9xroryotnrlvsm);
    }

    private LongClickInteraction(final r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM r8lambdaunavo3sxub_pc9xroryotnrlvsm) {
