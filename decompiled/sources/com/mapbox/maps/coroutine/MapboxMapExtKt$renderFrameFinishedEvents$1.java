...
public final class MapboxMapExtKt$renderFrameFinishedEvents$1 extends SuspendLambda implements r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 {
    final /* synthetic */ MapboxMap $this_renderFrameFinishedEvents;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.mapbox.maps.coroutine.MapboxMapExtKt$renderFrameFinishedEvents$1$1, reason: invalid class name */
    ...
    public final ShortNewsContentCardView<createFromParcel> create(Object obj, ShortNewsContentCardView<?> shortNewsContentCardView) {
        MapboxMapExtKt$renderFrameFinishedEvents$1 mapboxMapExtKt$renderFrameFinishedEvents$1 = new MapboxMapExtKt$renderFrameFinishedEvents$1(this.$this_renderFrameFinishedEvents, shortNewsContentCardView);
        mapboxMapExtKt$renderFrameFinishedEvents$1.L$0 = obj;
        return mapboxMapExtKt$renderFrameFinishedEvents$1;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            NativeObserver nativeObserver$maps_sdk_release = this.$this_renderFrameFinishedEvents.getNativeObserver$maps_sdk_release();
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(NativeObserver.subscribeRenderFrameFinished$default(nativeObserver$maps_sdk_release, mapboxMapExtKt$genericEvents$1$$ExternalSyntheticLambda0, new MapboxMapExtKt$renderFrameFinishedEvents$1$cancelable$2(producerCoroutine), null, 4, null));
            this.label = 1;
    ...
    public MapboxMapExtKt$renderFrameFinishedEvents$1(MapboxMap mapboxMap, ShortNewsContentCardView<? super MapboxMapExtKt$renderFrameFinishedEvents$1> shortNewsContentCardView) {
        super(2, shortNewsContentCardView);
        this.$this_renderFrameFinishedEvents = mapboxMap;
    }
    ...
    public final Object invoke(InAppMessageBackEventHandler1inAppMessageBackAnimationCallback1 inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, ShortNewsContentCardView<? super createFromParcel> shortNewsContentCardView) {
        return ((MapboxMapExtKt$renderFrameFinishedEvents$1) create(inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, shortNewsContentCardView)).invokeSuspend(createFromParcel.INSTANCE);
    }
}
