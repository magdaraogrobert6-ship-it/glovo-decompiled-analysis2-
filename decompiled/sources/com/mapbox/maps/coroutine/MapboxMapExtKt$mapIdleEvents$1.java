...
public final class MapboxMapExtKt$mapIdleEvents$1 extends SuspendLambda implements r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 {
    final /* synthetic */ MapboxMap $this_mapIdleEvents;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.mapbox.maps.coroutine.MapboxMapExtKt$mapIdleEvents$1$1, reason: invalid class name */
    ...
    public final ShortNewsContentCardView<createFromParcel> create(Object obj, ShortNewsContentCardView<?> shortNewsContentCardView) {
        MapboxMapExtKt$mapIdleEvents$1 mapboxMapExtKt$mapIdleEvents$1 = new MapboxMapExtKt$mapIdleEvents$1(this.$this_mapIdleEvents, shortNewsContentCardView);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            NativeObserver nativeObserver$maps_sdk_release = this.$this_mapIdleEvents.getNativeObserver$maps_sdk_release();
            MapIdleCallback mapIdleCallback = new MapIdleCallback() { // from class: com.mapbox.maps.coroutine.MapboxMapExtKt$mapIdleEvents$1$$ExternalSyntheticLambda0
                @Override // com.mapbox.maps.MapIdleCallback
                public final void run(MapIdle mapIdle) {
                    isInteropViewHost.RemoteActionCompatParcelizer(mapIdle, inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1);
                }
            };
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(NativeObserver.subscribeMapIdle$default(nativeObserver$maps_sdk_release, mapIdleCallback, new MapboxMapExtKt$mapIdleEvents$1$cancelable$2(producerCoroutine), null, 4, null));
            this.label = 1;
    ...
    public MapboxMapExtKt$mapIdleEvents$1(MapboxMap mapboxMap, ShortNewsContentCardView<? super MapboxMapExtKt$mapIdleEvents$1> shortNewsContentCardView) {
    ...
    public final Object invoke(InAppMessageBackEventHandler1inAppMessageBackAnimationCallback1 inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, ShortNewsContentCardView<? super createFromParcel> shortNewsContentCardView) {
        return ((MapboxMapExtKt$mapIdleEvents$1) create(inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, shortNewsContentCardView)).invokeSuspend(createFromParcel.INSTANCE);
    }
}
