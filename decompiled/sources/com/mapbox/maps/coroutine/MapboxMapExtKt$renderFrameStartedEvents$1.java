...
public final class MapboxMapExtKt$renderFrameStartedEvents$1 extends SuspendLambda implements r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 {
    final /* synthetic */ MapboxMap $this_renderFrameStartedEvents;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.mapbox.maps.coroutine.MapboxMapExtKt$renderFrameStartedEvents$1$1, reason: invalid class name */
    ...
    public final ShortNewsContentCardView<createFromParcel> create(Object obj, ShortNewsContentCardView<?> shortNewsContentCardView) {
        MapboxMapExtKt$renderFrameStartedEvents$1 mapboxMapExtKt$renderFrameStartedEvents$1 = new MapboxMapExtKt$renderFrameStartedEvents$1(this.$this_renderFrameStartedEvents, shortNewsContentCardView);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            NativeObserver nativeObserver$maps_sdk_release = this.$this_renderFrameStartedEvents.getNativeObserver$maps_sdk_release();
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(NativeObserver.subscribeRenderFrameStarted$default(nativeObserver$maps_sdk_release, mapboxMapExtKt$genericEvents$1$$ExternalSyntheticLambda0, new MapboxMapExtKt$renderFrameStartedEvents$1$cancelable$2(producerCoroutine), null, 4, null));
            this.label = 1;
    ...
    public MapboxMapExtKt$renderFrameStartedEvents$1(MapboxMap mapboxMap, ShortNewsContentCardView<? super MapboxMapExtKt$renderFrameStartedEvents$1> shortNewsContentCardView) {
    ...
    public final Object invoke(InAppMessageBackEventHandler1inAppMessageBackAnimationCallback1 inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, ShortNewsContentCardView<? super createFromParcel> shortNewsContentCardView) {
        return ((MapboxMapExtKt$renderFrameStartedEvents$1) create(inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, shortNewsContentCardView)).invokeSuspend(createFromParcel.INSTANCE);
    }
}
