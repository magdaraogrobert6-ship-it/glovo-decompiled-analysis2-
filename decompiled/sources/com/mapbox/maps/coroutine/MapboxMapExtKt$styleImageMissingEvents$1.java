...
public final class MapboxMapExtKt$styleImageMissingEvents$1 extends SuspendLambda implements r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 {
    final /* synthetic */ MapboxMap $this_styleImageMissingEvents;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.mapbox.maps.coroutine.MapboxMapExtKt$styleImageMissingEvents$1$1, reason: invalid class name */
    ...
    public final ShortNewsContentCardView<createFromParcel> create(Object obj, ShortNewsContentCardView<?> shortNewsContentCardView) {
        MapboxMapExtKt$styleImageMissingEvents$1 mapboxMapExtKt$styleImageMissingEvents$1 = new MapboxMapExtKt$styleImageMissingEvents$1(this.$this_styleImageMissingEvents, shortNewsContentCardView);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            NativeObserver nativeObserver$maps_sdk_release = this.$this_styleImageMissingEvents.getNativeObserver$maps_sdk_release();
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(NativeObserver.subscribeStyleImageMissing$default(nativeObserver$maps_sdk_release, mapboxMapExtKt$genericEvents$1$$ExternalSyntheticLambda0, new MapboxMapExtKt$styleImageMissingEvents$1$cancelable$2(producerCoroutine), null, 4, null));
            this.label = 1;
    ...
    public MapboxMapExtKt$styleImageMissingEvents$1(MapboxMap mapboxMap, ShortNewsContentCardView<? super MapboxMapExtKt$styleImageMissingEvents$1> shortNewsContentCardView) {
    ...
    public final Object invoke(InAppMessageBackEventHandler1inAppMessageBackAnimationCallback1 inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, ShortNewsContentCardView<? super createFromParcel> shortNewsContentCardView) {
        return ((MapboxMapExtKt$styleImageMissingEvents$1) create(inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, shortNewsContentCardView)).invokeSuspend(createFromParcel.INSTANCE);
    }
}
