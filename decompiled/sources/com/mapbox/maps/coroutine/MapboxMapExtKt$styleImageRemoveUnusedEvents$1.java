...
public final class MapboxMapExtKt$styleImageRemoveUnusedEvents$1 extends SuspendLambda implements r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 {
    final /* synthetic */ MapboxMap $this_styleImageRemoveUnusedEvents;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.mapbox.maps.coroutine.MapboxMapExtKt$styleImageRemoveUnusedEvents$1$1, reason: invalid class name */
    ...
    public final ShortNewsContentCardView<createFromParcel> create(Object obj, ShortNewsContentCardView<?> shortNewsContentCardView) {
        MapboxMapExtKt$styleImageRemoveUnusedEvents$1 mapboxMapExtKt$styleImageRemoveUnusedEvents$1 = new MapboxMapExtKt$styleImageRemoveUnusedEvents$1(this.$this_styleImageRemoveUnusedEvents, shortNewsContentCardView);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(NativeObserver.subscribeStyleImageRemoveUnused$default(nativeObserver$maps_sdk_release, mapboxMapExtKt$genericEvents$1$$ExternalSyntheticLambda0, new MapboxMapExtKt$styleImageRemoveUnusedEvents$1$cancelable$2(producerCoroutine), null, 4, null));
            this.label = 1;
    ...
    public MapboxMapExtKt$styleImageRemoveUnusedEvents$1(MapboxMap mapboxMap, ShortNewsContentCardView<? super MapboxMapExtKt$styleImageRemoveUnusedEvents$1> shortNewsContentCardView) {
    ...
    public final Object invoke(InAppMessageBackEventHandler1inAppMessageBackAnimationCallback1 inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, ShortNewsContentCardView<? super createFromParcel> shortNewsContentCardView) {
        return ((MapboxMapExtKt$styleImageRemoveUnusedEvents$1) create(inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, shortNewsContentCardView)).invokeSuspend(createFromParcel.INSTANCE);
    }
}
