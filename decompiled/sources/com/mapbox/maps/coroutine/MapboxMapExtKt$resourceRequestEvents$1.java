...
public final class MapboxMapExtKt$resourceRequestEvents$1 extends SuspendLambda implements r8lambdaa6_tctQMKSh3FK6HJGcbKuVdE0 {
    final /* synthetic */ MapboxMap $this_resourceRequestEvents;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.mapbox.maps.coroutine.MapboxMapExtKt$resourceRequestEvents$1$1, reason: invalid class name */
    ...
    public final ShortNewsContentCardView<createFromParcel> create(Object obj, ShortNewsContentCardView<?> shortNewsContentCardView) {
        MapboxMapExtKt$resourceRequestEvents$1 mapboxMapExtKt$resourceRequestEvents$1 = new MapboxMapExtKt$resourceRequestEvents$1(this.$this_resourceRequestEvents, shortNewsContentCardView);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            NativeObserver nativeObserver$maps_sdk_release = this.$this_resourceRequestEvents.getNativeObserver$maps_sdk_release();
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(nativeObserver$maps_sdk_release.subscribeResourceRequest(mapboxMapExtKt$genericEvents$1$$ExternalSyntheticLambda0, new MapboxMapExtKt$resourceRequestEvents$1$cancelable$2(producerCoroutine)));
            this.label = 1;
    ...
    public MapboxMapExtKt$resourceRequestEvents$1(MapboxMap mapboxMap, ShortNewsContentCardView<? super MapboxMapExtKt$resourceRequestEvents$1> shortNewsContentCardView) {
    ...
    public final Object invoke(InAppMessageBackEventHandler1inAppMessageBackAnimationCallback1 inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, ShortNewsContentCardView<? super createFromParcel> shortNewsContentCardView) {
        return ((MapboxMapExtKt$resourceRequestEvents$1) create(inAppMessageBackEventHandler1inAppMessageBackAnimationCallback1, shortNewsContentCardView)).invokeSuspend(createFromParcel.INSTANCE);
    }
}
