...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = BrazeDateFormat.IconCompatParcelizer[collection.ordinal()];
        if (i4 == 1 || i4 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = BrazeDateFormat.RemoteActionCompatParcelizer[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }
