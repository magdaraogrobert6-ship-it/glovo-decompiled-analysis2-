...
public final class x4w implements PG {
    public final yZI BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            Boolean bool = (Boolean) this.BGx.BGx.get();
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), bool, new HBR(new c6T(bool)));
        } catch (Throwable th) {
