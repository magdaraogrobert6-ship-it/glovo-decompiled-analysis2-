...
public final class cnH implements PG {
    public final BvF BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new z4S((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), new Lie(this.BGx.x(), this.BGx.hs()));
        } catch (Throwable th) {
