...
public final class DRh implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new QD((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), new SsA(SystemClock.elapsedRealtime(), System.currentTimeMillis(), KWh.BGx(), TimeZone.getDefault().getID()));
        } catch (Throwable th) {
