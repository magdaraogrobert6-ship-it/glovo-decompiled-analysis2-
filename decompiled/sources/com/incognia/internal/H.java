...
public final class H implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String lowerCase = this.BGx.BGx().BGx().toLowerCase(Locale.ROOT);
            isitemdismissable = new JWV((String) W4i.iaH.MediaSessionCompatResultReceiverWrapper(), lowerCase, new bMs(new Pp(lowerCase)));
        } catch (Throwable th) {
