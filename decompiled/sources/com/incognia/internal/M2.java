...
public final class M2 implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strMbG = this.BGx.mbG("android_id");
            isitemdismissable = new JWV((String) W4i.VV3.MediaSessionCompatResultReceiverWrapper(), strMbG, new bMs(new jM(strMbG)));
        } catch (Throwable th) {
