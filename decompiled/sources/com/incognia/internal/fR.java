...
public final class fR implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strHQ = this.BGx.HQ();
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strHQ, new bMs(new QW(strHQ)));
        } catch (Throwable th) {
