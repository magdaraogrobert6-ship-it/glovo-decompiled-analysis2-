...
public final class J5 implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strBGx = this.BGx.BGx("adb_enabled");
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strBGx, new bMs(new ur(strBGx)));
        } catch (Throwable th) {
