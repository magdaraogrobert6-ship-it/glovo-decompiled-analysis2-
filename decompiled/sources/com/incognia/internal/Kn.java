...
public final class Kn implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            Boolean bool = (Boolean) OY8.BGx.MediaSessionCompatResultReceiverWrapper();
            isitemdismissable = new JWV((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), bool, new HBR(new xaO(bool.booleanValue())));
        } catch (Throwable th) {
