...
public final class C2 implements PG {
    public final ZE BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            Boolean boolHs = this.BGx.hs();
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), boolHs, new HBR(new sgZ(boolHs)));
        } catch (Throwable th) {
