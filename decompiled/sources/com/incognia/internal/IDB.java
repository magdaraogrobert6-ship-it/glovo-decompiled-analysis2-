...
public final class IDB implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strMbG = this.BGx.mbG();
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strMbG, new bMs(new Neb(strMbG)));
        } catch (Throwable th) {
