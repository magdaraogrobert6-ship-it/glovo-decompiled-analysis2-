...
public final class qZ implements PG {
    public final ZlV BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new L5((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), new bh(Debug.isDebuggerConnected(), this.BGx.BGx()));
        } catch (Throwable th) {
