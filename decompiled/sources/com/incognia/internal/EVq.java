...
public final class EVq implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strBGx = this.BGx.BGx("stay_on_while_plugged_in");
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strBGx, new bMs(new u6q(strBGx)));
        } catch (Throwable th) {
