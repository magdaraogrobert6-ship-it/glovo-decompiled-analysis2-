...
public final class o7 implements PG {
    public final Ur9 BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            this.BGx.getClass();
            String strHQ = Ur9.HQ();
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strHQ, new bMs(new tzl(strHQ)));
        } catch (Throwable th) {
