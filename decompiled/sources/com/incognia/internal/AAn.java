...
public final class AAn implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strN = this.BGx.N();
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strN, new bMs(new eAJ(strN)));
        } catch (Throwable th) {
