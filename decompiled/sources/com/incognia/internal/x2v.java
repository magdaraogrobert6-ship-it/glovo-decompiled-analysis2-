...
public final class x2v implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            ...
            Xxc xxc = this.mbG;
            String str2 = (String) W4i.RF.MediaSessionCompatResultReceiverWrapper();
            Set set = this.N;
            if (set == null) {
                set = null;
            }
            ArrayList arrayListBGx = xxc.BGx(str2, set);
            isitemdismissable = new JWV((String) this.HQ.MediaSessionCompatResultReceiverWrapper(), arrayListBGx, new c8h(new VCa(arrayListBGx)));
        } catch (Throwable th) {
    ...
    public x2v(D4B d4b, Xxc xxc) {
        this.BGx = d4b;
        this.mbG = xxc;
        Object[] objArr = {OLL.BGx};
