...
public final class qWo implements PG {
    public final B9m BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new S2Y((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), this.BGx.BGx());
        } catch (Throwable th) {
