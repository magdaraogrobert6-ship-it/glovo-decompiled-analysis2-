...
public final class QAL extends Lambda implements r8lambdaRDpfSr94J4iEbcwX_KPqzPM8k0 {
    ...
    public QAL(Hwl hwl, String str, EventAddress eventAddress, String str2, EventProperties eventProperties, String str3, String str4) {
        super(0);
        this.BGx = hwl;
        this.mbG = str;
    ...
    public final Object invoke() {
        ...
        hwl.q.getClass();
        this.BGx.x.mbG.set(new VXy(zy5BGx, yo.BGx(eventAddress)));
