...
public final class YhS implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strBGx = XUh.BGx(XUh.BGx, 24, 0, 2) ? this.BGx.BGx("boot_count") : null;
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strBGx, new bMs(new kIR(strBGx)));
        } catch (Throwable th) {
