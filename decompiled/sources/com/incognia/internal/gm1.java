...
public final class gm1 implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String str = XUh.iaH;
            isitemdismissable = new JWV((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), str, new bMs(new db1(str)));
        } catch (Throwable th) {
