...
public final class st4 implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strBGx = P5.BGx();
            isitemdismissable = new JWV((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), strBGx, new bMs(new xH(strBGx)));
        } catch (Throwable th) {
