...
public final class e4 implements PG {
    public final b8O BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new p0((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), this.BGx.BGx());
        } catch (Throwable th) {
