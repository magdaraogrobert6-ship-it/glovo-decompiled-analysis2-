...
public final class iiX implements PG {
    public final uRS BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new th((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), new MRf(this.BGx.BGx(), this.BGx.mbG()));
        } catch (Throwable th) {
