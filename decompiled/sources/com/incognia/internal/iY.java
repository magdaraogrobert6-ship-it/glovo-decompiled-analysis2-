...
public final class iY implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new w4((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), onContentCardClicked.RemoteActionCompatParcelizer((Object[]) new Cmt[]{Ay.BGx.BGx(), Ay.mbG.BGx(), Ay.HQ.BGx()}));
        } catch (Throwable th) {
