...
public final class OFf implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new JWV((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), (String) g2.BGx.MediaSessionCompatResultReceiverWrapper(), new bMs(idZ.BGx));
        } catch (Throwable th) {
