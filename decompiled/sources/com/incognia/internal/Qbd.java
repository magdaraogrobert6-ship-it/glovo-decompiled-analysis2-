...
public final class Qbd extends Lambda implements r8lambdaUNavO3sxuB_PC9xRoryoTNrlvSM {
    public final /* synthetic */ int BGx;
    public final /* synthetic */ Callback HQ;
    public final /* synthetic */ int mbG;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Qbd(int i, int i2, Callback callback) {
        super(1);
        this.BGx = i;
        this.mbG = i2;
        this.HQ = callback;
    ...
    public final Object invoke(Object obj) {
        ...
        UsU usU = E79.BGx;
        E79.HQ(this.BGx);
        Incognia.INSTANCE.runOnMainThread(new c3(this.mbG, this.HQ, requestTokenWithStatus.getStatus() == RequestTokenStatus.SUCCESS ? requestTokenWithStatus.getToken() : null));
