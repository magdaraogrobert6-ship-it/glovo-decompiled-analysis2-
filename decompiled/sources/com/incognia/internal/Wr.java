...
public final class Wr implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new WO((String) this.BGx.MediaSessionCompatResultReceiverWrapper(), new h4O(XUh.q, XUh.fZl, XUh.e, String.valueOf(XUh.S)));
        } catch (Throwable th) {
