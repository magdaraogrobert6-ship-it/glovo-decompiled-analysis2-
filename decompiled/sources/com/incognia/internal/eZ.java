...
public final class eZ implements PG {
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            String strBGx = this.BGx.BGx("development_settings_enabled");
            isitemdismissable = new JWV((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), strBGx, new bMs(new nVK(strBGx)));
        } catch (Throwable th) {
