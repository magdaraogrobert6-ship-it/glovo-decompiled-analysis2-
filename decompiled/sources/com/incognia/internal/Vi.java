...
public final class Vi implements PG {
    public final I5P BGx;
    ...
    public final void BGx(y0S y0s, Ltx ltx) {
        ...
        try {
            isitemdismissable = new dZX((String) this.mbG.MediaSessionCompatResultReceiverWrapper(), new J19(this.BGx.mbG(), this.BGx.BGx()));
        } catch (Throwable th) {
