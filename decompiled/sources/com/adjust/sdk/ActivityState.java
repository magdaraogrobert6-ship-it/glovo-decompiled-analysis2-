...
public class ActivityState implements Serializable, Cloneable {
    ...
    static {
        ...
        ObjectStreamField objectStreamField2 = new ObjectStreamField(FeatureFlag.ENABLED, cls);
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        this.enabled = Util.readBooleanField(fields, FeatureFlag.ENABLED, true);
    ...
    public boolean equals(Object obj) {
        ...
        if (!Util.equalBoolean(Boolean.valueOf(this.isGdprForgotten), Boolean.valueOf(activityState.isGdprForgotten))) {
            return false;
        }
        if (!Util.equalBoolean(Boolean.valueOf(this.isThirdPartySharingDisabledForCoppa), Boolean.valueOf(activityState.isThirdPartySharingDisabledForCoppa))) {
            return false;
        }
        ...
        if (!Util.equalLong(Long.valueOf(this.lastInterval), Long.valueOf(activityState.lastInterval)) || !Util.equalObject(this.orderIds, activityState.orderIds) || !Util.equalString(this.pushToken, activityState.pushToken) || !Util.equalString(this.adid, activityState.adid)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTime), Long.valueOf(activityState.clickTime))) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.installBegin), Long.valueOf(activityState.installBegin)) || !Util.equalString(this.installReferrer, activityState.installReferrer) || !Util.equalBoolean(this.googlePlayInstant, activityState.googlePlayInstant)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTimeServer), Long.valueOf(activityState.clickTimeServer))) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.installBeginServer), Long.valueOf(activityState.installBeginServer)) || !Util.equalString(this.installVersion, activityState.installVersion)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTimeHuawei), Long.valueOf(activityState.clickTimeHuawei))) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.installBeginHuawei), Long.valueOf(activityState.installBeginHuawei)) || !Util.equalString(this.installReferrerHuawei, activityState.installReferrerHuawei) || !Util.equalString(this.installReferrerHuaweiAppGallery, activityState.installReferrerHuaweiAppGallery)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTimeXiaomi), Long.valueOf(activityState.clickTimeXiaomi))) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.installBeginXiaomi), Long.valueOf(activityState.installBeginXiaomi)) || !Util.equalString(this.installReferrerXiaomi, activityState.installReferrerXiaomi)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTimeServerXiaomi), Long.valueOf(activityState.clickTimeServerXiaomi))) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.installBeginServerXiaomi), Long.valueOf(activityState.installBeginServerXiaomi)) || !Util.equalString(this.installVersionXiaomi, activityState.installVersionXiaomi)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTimeSamsung), Long.valueOf(activityState.clickTimeSamsung))) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.installBeginSamsung), Long.valueOf(activityState.installBeginSamsung)) || !Util.equalString(this.installReferrerSamsung, activityState.installReferrerSamsung)) {
            return false;
        }
        if (!Util.equalLong(Long.valueOf(this.clickTimeVivo), Long.valueOf(activityState.clickTimeVivo))) {
            return false;
        }
        if (Util.equalLong(Long.valueOf(this.installBeginVivo), Long.valueOf(activityState.installBeginVivo)) && Util.equalString(this.installReferrerVivo, activityState.installReferrerVivo) && Util.equalString(this.installVersionVivo, activityState.installVersionVivo) && Util.equalString(this.installReferrerMeta, activityState.installReferrerMeta)) {
            return Util.equalLong(Long.valueOf(this.clickTimeMeta), Long.valueOf(activityState.clickTimeMeta)) && Util.equalBoolean(this.isClickMeta, activityState.isClickMeta);
        }
        return false;
    }
}
