...
import o.Csynchronized;
import o.LayerMatrixCache;
import o.calculateInverseMatrixbWbORWo;
import o.calculateMatrixGrdbGEg;
...
public final class QuotaFailure extends GeneratedMessageLite implements dumpRenderNodeData {
    ...
    public static final class Violation extends GeneratedMessageLite implements LayerMatrixCache {
        ...
        public static Csynchronized newBuilder() {
            return (Csynchronized) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public final Object dynamicMethod(CompositionLocalsKtLocalTextToolbar1 compositionLocalsKtLocalTextToolbar1, Object obj, Object obj2) {
            ...
            switch (calculateMatrixGrdbGEg.RemoteActionCompatParcelizer[compositionLocalsKtLocalTextToolbar1.ordinal()]) {
                case 1:
                    return new Violation();
                case 2:
                    return new Csynchronized(DEFAULT_INSTANCE);
                case 3:
        ...
        public static Csynchronized newBuilder(Violation violation) {
            return (Csynchronized) DEFAULT_INSTANCE.createBuilder(violation);
        }
    ...
    public List<? extends LayerMatrixCache> getViolationsOrBuilderList() {
        return this.violations_;
    }
    ...
    public static calculateInverseMatrixbWbORWo newBuilder() {
        return (calculateInverseMatrixbWbORWo) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(CompositionLocalsKtLocalTextToolbar1 compositionLocalsKtLocalTextToolbar1, Object obj, Object obj2) {
        ...
        switch (calculateMatrixGrdbGEg.RemoteActionCompatParcelizer[compositionLocalsKtLocalTextToolbar1.ordinal()]) {
            ...
            case 2:
                return new calculateInverseMatrixbWbORWo(DEFAULT_INSTANCE);
            case 3:
    ...
    public LayerMatrixCache getViolationsOrBuilder(int i) {
        return (LayerMatrixCache) this.violations_.get(i);
    }
    ...
    public static calculateInverseMatrixbWbORWo newBuilder(QuotaFailure quotaFailure) {
        return (calculateInverseMatrixbWbORWo) DEFAULT_INSTANCE.createBuilder(quotaFailure);
    }

    public static QuotaFailure parseDelimitedFrom(InputStream inputStream, getLocalProvidableScrollCaptureInProgress getlocalprovidablescrollcaptureinprogress) throws IOException {
        return (QuotaFailure) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, getlocalprovidablescrollcaptureinprogress);
    }

    public static QuotaFailure parseFrom(ByteBuffer byteBuffer, getLocalProvidableScrollCaptureInProgress getlocalprovidablescrollcaptureinprogress) throws InvalidProtocolBufferException {
        return (QuotaFailure) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, getlocalprovidablescrollcaptureinprogress);
    }

    public static QuotaFailure parseFrom(getClipMetadata getclipmetadata) throws InvalidProtocolBufferException {
        return (QuotaFailure) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getclipmetadata);
    }

    public static QuotaFailure parseFrom(getClipMetadata getclipmetadata, getLocalProvidableScrollCaptureInProgress getlocalprovidablescrollcaptureinprogress) throws InvalidProtocolBufferException {
        return (QuotaFailure) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, getclipmetadata, getlocalprovidablescrollcaptureinprogress);
    }
    ...
    public static QuotaFailure parseFrom(byte[] bArr, getLocalProvidableScrollCaptureInProgress getlocalprovidablescrollcaptureinprogress) throws InvalidProtocolBufferException {
        return (QuotaFailure) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, getlocalprovidablescrollcaptureinprogress);
    }
    ...
    public static QuotaFailure parseFrom(InputStream inputStream, getLocalProvidableScrollCaptureInProgress getlocalprovidablescrollcaptureinprogress) throws IOException {
        return (QuotaFailure) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, getlocalprovidablescrollcaptureinprogress);
    }
    ...
    public static QuotaFailure parseFrom(CodedInputStream codedInputStream, getLocalProvidableScrollCaptureInProgress getlocalprovidablescrollcaptureinprogress) throws IOException {
        return (QuotaFailure) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, getlocalprovidablescrollcaptureinprogress);
    }
}
