...
public class InvalidProtocolBufferException extends IOException {
    ...
    public static InvalidProtocolBufferException MediaMetadataCompat() {
    ...
    public static InvalidWireTypeException serializer() {
    ...
    public InvalidProtocolBufferException(String str, Throwable th) {
        super(str, th);
    }
