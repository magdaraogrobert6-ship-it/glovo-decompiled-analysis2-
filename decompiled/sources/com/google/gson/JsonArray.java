...
public final class JsonArray extends JsonElement implements Iterable<JsonElement> {
    ...
    private JsonElement getAsSingleElement() {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.write(c8$$ExternalSyntheticOutline0.m(size, "Array must have size 1, but has size "));
        return null;
    }
    ...
    public static int IconCompatParcelizer() {
        ...
        int iNextInt = new Random().nextInt(156019144);
        write = iNextInt;
        return iNextInt;
    }
}
