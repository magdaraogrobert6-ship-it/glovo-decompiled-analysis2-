...
public final class GsonTypes {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Class<?> cls, Type... typeArr) {
            ...
            if (type == null && GsonTypes.requiresOwnerType(cls)) {
                ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer(c8$$ExternalSyntheticOutline0.m(cls, "Must specify owner type for "));
                throw null;
            }
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            if (typeArr2.length > 1) {
                ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("At most one lower bound is supported");
                throw null;
            }
            if (typeArr.length != 1) {
                ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("Exactly one upper bound must be specified");
                throw null;
            }
            if (typeArr2.length != 1) {
            ...
            if (typeArr[0] != Object.class) {
                ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("When lower bound is specified, upper bound must be Object");
                throw null;
            }
    ...
    public static void checkNotPrimitive(Type type) {
        if ((type instanceof Class) && ((Class) type).isPrimitive()) {
            ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("Primitive type is not allowed");
        }
    }
