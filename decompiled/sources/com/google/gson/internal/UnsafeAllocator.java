...
public abstract class UnsafeAllocator {
    ...
    public static void assertInstantiable(Class<?> cls) {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.write((Object) "UnsafeAllocator is used for non-instantiable type: ".concat(strCheckInstantiable));
    }
                ...
                try {
                    ...
                    return new UnsafeAllocator() { // from class: com.google.gson.internal.UnsafeAllocator.4
                        ...
                        public <T> T newInstance(Class<T> cls2) {
                            throw new UnsupportedOperationException(d$$ExternalSyntheticOutline0.m(cls2, "Cannot allocate ", ". Usage of JDK sun.misc.Unsafe is enabled, but it could not be used. Make sure your runtime is configured correctly."));
                        }
                    };
                }
