...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) throws JsonIOException {
        try {
            ...
            StringBuilder sbM = c8$$ExternalSyntheticOutline0.m("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbM.append(getInaccessibleTroubleshootingSuffix(e));
            throw new JsonIOException(sbM.toString(), e);
        }
    }
