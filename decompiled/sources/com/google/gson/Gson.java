...
public final class Gson {
    ...
    public static class FutureTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
        ...
        public void setDelegate(TypeAdapter<T> typeAdapter) {
            if (this.delegate == null) {
                ...
                ScreenStartObserver$$ExternalSyntheticLambda0.write((Object) "Delegate is already set");
            }
        }
        ...
        private TypeAdapter<T> delegate() {
            ...
            ScreenStartObserver$$ExternalSyntheticLambda0.write("Adapter for type with cyclic dependency has been used before dependency has been resolved");
            return null;
        }
    }
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> typeToken) {
        ...
        try {
            ...
            if (typeAdapterCreate == null) {
                Gson$$ExternalSyntheticBUOutline0.m(typeToken, "GSON (2.13.2) cannot handle ");
                return null;
            }
            if (z) {
    ...
    public <T> TypeAdapter<T> getDelegateAdapter(TypeAdapterFactory typeAdapterFactory, TypeToken<T> typeToken) {
        ...
        Gson$$ExternalSyntheticBUOutline0.m(typeToken, "GSON cannot serialize or deserialize ");
        return null;
    }
