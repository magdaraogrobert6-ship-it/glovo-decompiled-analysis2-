...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeAdapter(Type type, Object obj) {
        ...
        if (!z && !(obj instanceof JsonDeserializer) && !(obj instanceof InstanceCreator) && !(obj instanceof TypeAdapter)) {
            r8lambdayUqGVEpC1kg8ua3jc9a113shNIE.read("Class ", obj.getClass().getName(), " does not implement any supported type adapter class or interface");
            return null;
        }
        if (hasNonOverridableAdapter(type)) {
            Gson$$ExternalSyntheticBUOutline0.m(type, "Cannot override built-in adapter for ");
            return null;
        }
    ...
    public GsonBuilder setDateFormat(String str) {
        if (str != null) {
            try {
                ...
                throw new IllegalArgumentException(ff$$ExternalSyntheticOutline0.m("The date pattern '", str, "' is not valid"), e);
            }
        }
    ...
    private static int checkDateFormatStyle(int i) {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer(c8$$ExternalSyntheticOutline0.m(i, "Invalid style: "));
        return 0;
    }

    public GsonBuilder setVersion(double d) {
        if (Double.isNaN(d) || d < 0.0d) {
            ActivityLifecycleIntegration$$ExternalSyntheticLambda1.read("Invalid version: ", d);
            return null;
        }
