...
public final class CaptionedImageCard extends Card {
    ...
    public CaptionedImageCard(JSONObject jSONObject, i9 i9Var, ICardStorageProvider<?> iCardStorageProvider, m9 m9Var) throws JSONException {
    ...
    public CaptionedImageCard(JSONObject jSONObject, i9 i9Var) {
        this(jSONObject, i9Var, null, null, 12, null);
        jSONObject.getClass();
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public CaptionedImageCard(JSONObject jSONObject, i9 i9Var, ICardStorageProvider<?> iCardStorageProvider) {
    ...
    public /* synthetic */ CaptionedImageCard(JSONObject jSONObject, i9 i9Var, ICardStorageProvider iCardStorageProvider, m9 m9Var, int i, DefaultConstructorMarker defaultConstructorMarker) {
