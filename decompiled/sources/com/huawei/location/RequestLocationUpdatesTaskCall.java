...
public class RequestLocationUpdatesTaskCall extends BaseApiRequest {
    ...
    private createAndInstallWindowRecomposerui hwLocationCallback = new i$d.a(10, this);

    private boolean checkNeedOffLineLocation(LocationRequest locationRequest) {
        WrappedCompositionsetContent1211.RemoteActionCompatParcelizer(TAG, "checkNeedOffLineLocation");
        if (!agcFail()) {
            return true;
        }
        ...
        WrappedCompositionsetContent1211.RemoteActionCompatParcelizer(TAG, "agc fail ,but use offLine");
        return true;
    }
    ...
    public void onRequest(String str) {
        ...
        try {
            ...
            getOnSelectAllRequested.write().RemoteActionCompatParcelizer(new getGlobalKeyboardModifiersui(requestLocationUpdatesRequest), this.hwLocationCallback);
