...
public class GnssClock {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GnssClock{mElapsedRealtimeMillis=");
        sb.append(this.mElapsedRealtimeMillis);
        sb.append(", mTimeNanos=");
        sb.append(this.mTimeNanos);
        sb.append(", mLeapSecond=");
        sb.append(this.mLeapSecond);
        sb.append(", mTimeUncertaintyNanos=");
        sb.append(this.mTimeUncertaintyNanos);
        sb.append(", mFullBiasNanos=");
        sb.append(this.mFullBiasNanos);
        sb.append(", mBiasNanos=");
        sb.append(this.mBiasNanos);
        sb.append(", mBiasUncertaintyNanos=");
        sb.append(this.mBiasUncertaintyNanos);
        sb.append(", mDriftNanosPerSecond=");
        sb.append(this.mDriftNanosPerSecond);
        sb.append(", mDriftUncertaintyNanosPerSecond=");
        sb.append(this.mDriftUncertaintyNanosPerSecond);
        sb.append(", mHardwareClockDiscontinuityCount=");
        return af$$ExternalSyntheticOutline0.m(sb, this.mHardwareClockDiscontinuityCount, '}');
    }
}
