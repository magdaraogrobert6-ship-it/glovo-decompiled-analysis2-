...
public class SatelliteMeasurement {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("SatelliteMeasurement{mSvid=");
        sb.append(this.mSvid);
        sb.append(", mConstellationType=");
        sb.append(this.mConstellationType);
        sb.append(", mTimeOffsetNanos=");
        sb.append(this.mTimeOffsetNanos);
        sb.append(", mState=");
        sb.append(this.mState);
        sb.append(", mReceivedSvTimeNanos=");
        sb.append(this.mReceivedSvTimeNanos);
        sb.append(", mReceivedSvTimeUncertaintyNanos=");
        sb.append(this.mReceivedSvTimeUncertaintyNanos);
        sb.append(", mCn0DbHz=");
        sb.append(this.mCn0DbHz);
        sb.append(", mPseudorangeRateMetersPerSecond=");
        sb.append(this.mPseudorangeRateMetersPerSecond);
        sb.append(", mPseudorangeRateUncertaintyMetersPerSecond=");
        sb.append(this.mPseudorangeRateUncertaintyMetersPerSecond);
        sb.append(", mAccumulatedDeltaRangeState=");
        sb.append(this.mAccumulatedDeltaRangeState);
        sb.append(", mAccumulatedDeltaRangeMeters=");
        sb.append(this.mAccumulatedDeltaRangeMeters);
        sb.append(", mAccumulatedDeltaRangeUncertaintyMeters=");
        sb.append(this.mAccumulatedDeltaRangeUncertaintyMeters);
        sb.append(", mCarrierFrequencyHz=");
        sb.append(this.mCarrierFrequencyHz);
        sb.append(", mCarrierCycles=");
        sb.append(this.mCarrierCycles);
        sb.append(", mCarrierPhase=");
        sb.append(this.mCarrierPhase);
        sb.append(", mCarrierPhaseUncertainty=");
        sb.append(this.mCarrierPhaseUncertainty);
        sb.append(", mMultipathIndicator=");
        sb.append(this.mMultipathIndicator);
        sb.append(", mSnrInDb=");
        sb.append(this.mSnrInDb);
        sb.append(", mAutomaticGainControlLevelInDb=");
        sb.append(this.mAutomaticGainControlLevelInDb);
        sb.append(", mFullInterSignalBiasNanos=");
        sb.append(this.mFullInterSignalBiasNanos);
        sb.append(", mFullInterSignalBiasUncertaintyNanos=");
        sb.append(this.mFullInterSignalBiasUncertaintyNanos);
        sb.append(", mSatelliteInterSignalBiasNanos=");
        sb.append(this.mSatelliteInterSignalBiasNanos);
        sb.append(", mSatelliteInterSignalBiasUncertaintyNanos=");
        sb.append(this.mSatelliteInterSignalBiasUncertaintyNanos);
        sb.append(", mBootTime=");
        return r8lambdafvzP3Wky1RLLzE56uVXaMHcvU.read(sb, this.mBootTime, '}');
    }
}
