...
public class r1 extends b<q0, Void> {
    ...
    public void doExecute(q0 q0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("SetMockLocationTaskApiCall", ((b) this).a, "doExecute");
            ...
            HMSLocationLog.e("SetMockLocationTaskApiCall", ((b) this).a, "doExecute exception");
