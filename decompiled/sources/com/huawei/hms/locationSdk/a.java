...
public class a extends b<t0, Void> {
    ...
    public void doExecute(t0 t0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("AddGeofencesTaskApiCall", ((b) this).a, "add geofences doExecute");
            ...
            IconCompatParcelizer.RemoteActionCompatParcelizer(e, new StringBuilder("add geofences doExecute exception:"), "AddGeofencesTaskApiCall", ((b) this).a);
            viewLayerCompanionOutlineProvider1.read(e);
        } catch (Exception unused) {
            HMSLocationLog.e("AddGeofencesTaskApiCall", ((b) this).a, "add geofences doExecute exception");
