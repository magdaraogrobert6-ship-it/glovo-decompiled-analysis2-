...
public class n1 extends b<r0, Void> {
    ...
    public void doExecute(r0 r0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("RequestReportLocationTaskApiCall", ((b) this).a, "doExecute");
            ...
            HMSLocationLog.e("RequestReportLocationTaskApiCall", ((b) this).a, "doExecute exception");
