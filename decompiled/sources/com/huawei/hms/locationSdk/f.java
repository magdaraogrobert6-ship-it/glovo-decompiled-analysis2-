...
public class f extends b<s0, List<HWLocation>> {
    private Context d;
    ...
    public void doExecute(s0 s0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("GetFromLocationNameTaskApiCall", ((b) this).a, "doExecute");
            ...
            IconCompatParcelizer.RemoteActionCompatParcelizer(e, new StringBuilder("getFromLocationName doExecute exception:"), "GetFromLocationNameTaskApiCall", ((b) this).a);
            viewLayerCompanionOutlineProvider1.read(e);
        } catch (Exception unused) {
            HMSLocationLog.e("GetFromLocationNameTaskApiCall", ((b) this).a, "getFromLocationName doExecute exception");
