...
public class y0 extends b<p0, Void> {
    private e1 d;

    public y0(String str, String str2, e1 e1Var) {
    ...
    public void doExecute(p0 p0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("RemoveActivityUpdatesTaskApiCall", ((b) this).a, "remove Activity doExecute");
            ...
            HMSLocationLog.e("RemoveActivityUpdatesTaskApiCall", ((b) this).a, "doExecute exception");
