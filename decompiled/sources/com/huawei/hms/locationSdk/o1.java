...
public class o1 extends b<r0, Void> {
    ...
    public void doExecute(r0 r0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("RequestStationRecognitionTaskApiCall", ((b) this).a, "doExecute");
            ...
            HMSLocationLog.e("RequestStationRecognitionTaskApiCall", ((b) this).a, "doExecute exception");
