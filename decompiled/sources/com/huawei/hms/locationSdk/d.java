...
public class d extends b<q0, Void> {
    ...
    public void doExecute(q0 q0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        HMSLocationLog.i("DisableBackgroundLocationTaskApiCall", ((b) this).a, "doExecute");
        try {
            ...
            HMSLocationLog.e("DisableBackgroundLocationTaskApiCall", ((b) this).a, "disable background location doExecute exception");
