...
public class l extends b<r0, LocationSceneResponse> {
    ...
    public void doExecute(r0 r0Var, ResponseErrorCode responseErrorCode, String str, ViewLayerCompanionOutlineProvider1 viewLayerCompanionOutlineProvider1) {
        try {
            HMSLocationLog.i("GetLocationSceneResponseTaskApiCall", ((b) this).a, "doExecute");
            ...
            IconCompatParcelizer.RemoteActionCompatParcelizer(e, new StringBuilder("get last location doExecute exception:"), "GetLocationSceneResponseTaskApiCall", ((b) this).a);
            viewLayerCompanionOutlineProvider1.read(e);
        } catch (Exception unused) {
            HMSLocationLog.e("GetLocationSceneResponseTaskApiCall", ((b) this).a, "get last location doExecute exception");
