    ...
    public static boolean a(String str, String str2, int i) {
        ...
        if (TextUtils.isEmpty(strA) || TextUtils.isEmpty(str2)) {
            ...
            if (!TextUtils.isEmpty(strA2)) {
                if (str2.equals(ComposeScrollCaptureCallbackscrollTracker1.IconCompatParcelizer(strA))) {
                    return true;
                }
                if (!str2.equals(ComposeScrollCaptureCallbackscrollTracker1.IconCompatParcelizer(strA2))) {
                    return false;
                }
                try {
