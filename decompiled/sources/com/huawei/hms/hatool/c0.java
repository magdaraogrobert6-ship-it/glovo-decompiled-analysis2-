...
public class c0 {
    ...
    public static boolean a(Context context, String str, int i) {
        ...
        File file = new File(context.getFilesDir(), "../shared_prefs/".concat(str2));
        if (!file.exists()) {
            file = new File(context.getFilesDir(), "../../shared_prefs/".concat(context.getPackageName() + BundleUtil.UNDERLINE_TAG + str2));
        }
