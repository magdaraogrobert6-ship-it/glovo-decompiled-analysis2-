...
public class PackageManagerCompat {
    ...
    private static final String VERSION = "8.0.1.313";
    ...
    public static String getAppVersion(Context context) {
        ...
        try {
            sAppVersion = String.valueOf(packageManager.getPackageInfo(context.getPackageName(), Fields.Clip).versionCode);
    ...
    public static String getAppPackageName(Context context) {
        ...
        try {
            return packageManager.getPackageInfo(context.getPackageName(), Fields.Clip).packageName;
        } catch (PackageManager.NameNotFoundException | RuntimeException unused) {
            Logger.w(TAG, "Failed to get Package managers Package Info");
            return "";
        }
