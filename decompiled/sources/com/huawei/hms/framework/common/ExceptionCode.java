...
public class ExceptionCode {
    ...
    private static int getErrorCodeSocketTimeout(Exception exc) {
        ...
        strCheckExceptionContainsKey.getClass();
        int iHashCode = strCheckExceptionContainsKey.hashCode();
        if (iHashCode != 3496342) {
            if (iHashCode != 113399775) {
                if (iHashCode == 951351530 && strCheckExceptionContainsKey.equals(CONNECT)) {
                    b = 2;
                } else {
                    b = -1;
                }
        ...
        if (b != 1) {
            return b != 2 ? SOCKET_TIMEOUT : SOCKET_CONNECT_TIMEOUT;
        }
