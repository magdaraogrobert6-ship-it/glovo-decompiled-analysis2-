...
public class LocationSettingsRequest implements IMessageEntity, Parcelable {
    ...
    public final class yn implements Parcelable.Creator<LocationSettingsRequest> {
    ...
    public /* synthetic */ LocationSettingsRequest(List list, boolean z, boolean z2, yn ynVar) {
        this(list, z, z2);
    }
}
