...
public class PushPreferences {
    ...
    private File a(Context context, String str) {
        try {
            ...
            m1$$ExternalSyntheticOutline0.m(e, new StringBuilder("get failed error."), TAG);
            return null;
        }
    }
    ...
    private SharedPreferences b(Context context, String str) {
        ...
        try {
            ...
            m1$$ExternalSyntheticOutline0.m(e, new StringBuilder("get SharedPreferences error."), TAG);
            return null;
        }
    }
