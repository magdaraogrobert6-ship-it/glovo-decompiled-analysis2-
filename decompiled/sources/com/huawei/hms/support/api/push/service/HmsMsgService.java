    ...
    public static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (Objects.equals(this.a.getApplicationContext().getPackageManager().getNameForUid(message.sendingUid), HMSPackageManager.getInstance(this.a).getHMSPackageName()) && data != null) {
                PackageManagerHelper.PackageStates hMSPackageStates = HMSPackageManager.getInstance(this.a).getHMSPackageStates();
                ...
                if (hMSPackageStates == packageStates) {
                    if (HMSPackageManager.getInstance(this.a).getHMSPackageStates() != packageStates) {
