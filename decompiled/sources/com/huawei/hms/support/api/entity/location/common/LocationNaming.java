...
public class LocationNaming {
    ...
    public static final String GET_HISTORY_STATION_INFO = "location.getHistoryStationInfo";
    ...
    public static final String GET_STATION_LINE = "location.getStationLines";
