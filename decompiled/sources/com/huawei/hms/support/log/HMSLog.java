...
public class HMSLog {
    ...
    private static String a(Context context) {
        ...
        try {
            PackageInfo packageInfo = packageManager.getPackageInfo(context.getPackageName(), Fields.Clip);
    ...
    public static void setExtLogger(HMSExtLogger hMSExtLogger, boolean z) throws IllegalArgumentException {
        ...
        ScreenStartObserver$$ExternalSyntheticLambda0.IconCompatParcelizer("extLogger is not able to be null");
    }
