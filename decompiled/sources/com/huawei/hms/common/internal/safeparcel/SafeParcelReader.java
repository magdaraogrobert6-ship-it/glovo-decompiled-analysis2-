...
public class SafeParcelReader {
    ...
    private static void a(Parcel parcel, int i, int i2, int i3) {
        ...
        c8$$ExternalSyntheticOutline0.m(i3, i2, "Expected size ", " got ", sb);
        throw new ParseException(d$$ExternalSyntheticOutline0.m(sb, " (0x", hexString, ")"), parcel);
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(af$$ExternalSyntheticOutline0.m(iDataPosition, "invalid start=", i, " end="), parcel);
        }
        return i;
    }
    ...
    private static void b(Parcel parcel, int i, int i2) {
        ...
        StringBuilder sb = new StringBuilder(hexString.length() + 46);
        c8$$ExternalSyntheticOutline0.m(i2, size, "Expected size ", " got ", sb);
        throw new ParseException(d$$ExternalSyntheticOutline0.m(sb, " (0x", hexString, ")"), parcel);
    }
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(c8$$ExternalSyntheticOutline0.m(i, "Overread allowed size end="), parcel);
        }
    }
