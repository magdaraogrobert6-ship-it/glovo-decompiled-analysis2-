...
final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    public class a implements BusResponseCallback {
        final /* synthetic */ ViewLayerCompanionOutlineProvider1[] a;

        public a(ViewLayerCompanionOutlineProvider1[] viewLayerCompanionOutlineProvider1Arr) {
            this.a = viewLayerCompanionOutlineProvider1Arr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i, String str) {
            ...
            this.a[0].read(new AvailabilityException());
            return null;
        }
    ...
    /* JADX WARN: Code duplicated, block: B:10:0x0013 A[Catch: AvailabilityException -> 0x000b, TRY_LEAVE, TryCatch #0 {AvailabilityException -> 0x000b, blocks: (B:4:0x0007, B:8:0x000f, B:10:0x0013), top: B:14:0x0007 }] */
    /* JADX WARN: Code duplicated, block: B:8:0x000f A[Catch: AvailabilityException -> 0x000b, TryCatch #0 {AvailabilityException -> 0x000b, blocks: (B:4:0x0007, B:8:0x000f, B:10:0x0013), top: B:14:0x0007 }] */
    /* JADX WARN: Instruction removed from duplicated block: B:8:0x000f, please report this as an issue */
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public setShouldUseDispatchDrawui checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr) {
        int i;
    ...
    public void resolveError(Activity activity, int i, int i2, PendingIntent pendingIntent) {
        ...
        if (pendingIntent != null) {
            r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter resolveError, param pendingIntent is not null. and.errorCode: ", "HuaweiApiAvailabilityImpl");
        } else {
            r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter resolveError, param pendingIntent is  null. get pendingIntent from error code.and.errorCode: ", "HuaweiApiAvailabilityImpl");
            pendingIntent = getResolveErrorPendingIntent(activity, i);
        }
        if (pendingIntent != null) {
            r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "In resolveError, start pendingIntent.errorCode: ", "HuaweiApiAvailabilityImpl");
            try {
    ...
    private Intent a(Activity activity, int i) {
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "getErrorResolutionIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
        if (i == 1 || i == 2) {
    ...
    public Intent getResolveErrorIntent(Activity activity, int i) {
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter getResolveErrorIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
        if (activity == null) {
            return null;
        }
        if (i == 1 || i == 2) {
    ...
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i) {
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter getResolveErrorPendingIntent, errorCode: ", "HuaweiApiAvailabilityImpl");
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public setShouldUseDispatchDrawui getHuaweiServicesReady(Activity activity) {
        Preconditions.checkNotNull(activity);
        ViewLayerCompanionOutlineProvider1[] viewLayerCompanionOutlineProvider1Arr = {new ViewLayerCompanionOutlineProvider1()};
        ViewLayerUniqueDrawingIdApi29 viewLayerUniqueDrawingIdApi29 = viewLayerCompanionOutlineProvider1Arr[0].RemoteActionCompatParcelizer;
        ...
        if (resolveErrorIntent != null) {
            ForegroundIntentBuilder.registerResponseCallback(ResolutionDelegate.CALLBACK_METHOD, new a(viewLayerCompanionOutlineProvider1Arr));
        ...
        if (iIsHuaweiMobileServicesAvailable == 3) {
        ...
        viewLayerCompanionOutlineProvider1Arr[0].read(new AvailabilityException());
        return viewLayerUniqueDrawingIdApi29;
    }
    ...
    /* JADX WARN: Instruction removed from duplicated block: B:8:0x000f, please report this as an issue */
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public setShouldUseDispatchDrawui checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr) {
        int i;
        ViewLayerUniqueDrawingIdApi29 viewLayerUniqueDrawingIdApi29 = new ViewLayerUniqueDrawingIdApi29();
    ...
    private UpdateBean a(Context context) {
        ...
        try {
            ...
            m1$$ExternalSyntheticOutline0.m(e, new StringBuilder("getString has Exception:"), "HuaweiApiAvailabilityImpl");
            return updateBean;
        }
    }
