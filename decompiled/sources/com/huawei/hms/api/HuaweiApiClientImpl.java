...
public class HuaweiApiClientImpl extends HuaweiApiClient implements InnerApiClient, ServiceConnection {
    ...
    private void i() {
        synchronized (B) {
            ...
            HMSLog.d("HuaweiApiClientImpl", "sendEmptyMessageDelayed for onConnectionResult 3 seconds. the result is : " + this.y.sendEmptyMessageDelayed(3, ConstantsKt.DEFAULT_REQUEST_TIMEOUT));
        }
    }
    ...
    public void disconnect() {
        int i = this.k.get();
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter disconnect, Connection Status: ", "HuaweiApiClientImpl");
        if (i == 2) {
            c(4);
            return;
        }
    ...
    public void a(ResolveResult<ConnectResp> resolveResult) {
        ...
        if (this.f != null && this.k.get() == 2) {
            ...
            SubAppInfo subAppInfo = this.f29o;
            ...
            r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(statusCode, "Enter onConnectionResult, connect to server result: ", "HuaweiApiClientImpl");
    ...
    public void connect(Activity activity) {
        ...
        int i = this.k.get();
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter connect, Connection Status: ", "HuaweiApiClientImpl");
        if (i == 3 || i == 5 || i == 2 || i == 4) {
            return;
        }
        if (activity != null) {
        ...
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(iIsHuaweiMobileServicesAvailable, "In connect, isHuaweiMobileServicesAvailable result: ", "HuaweiApiClientImpl");
    ...
    public void connectForeground() {
        ...
        HMSLog.i("HuaweiApiClientImpl", "====== HMSSDK version: 61300303 ======");
        int i = this.k.get();
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "Enter forceConnect, Connection Status: ", "HuaweiApiClientImpl");
        if (i == 3 || i == 5 || i == 2 || i == 4) {
            return;
        }
        if (TextUtils.isEmpty(this.c)) {
    ...
    public void disableLifeCycleManagement(Activity activity) {
        if (this.a >= 0) {
            ...
            ScreenStartObserver$$ExternalSyntheticLambda0.write("disableLifeCycleManagement failed");
        }
    }
    ...
    public ConnectionResult holdUpConnect(long j, TimeUnit timeUnit) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ScreenStartObserver$$ExternalSyntheticLambda0.write("blockingConnect must not be called on the UI thread");
            return null;
        }
        this.s.lock();
        try {
    ...
    public boolean isConnected() {
        ...
        Status status = ((ResolveResult) ConnectService.checkconnect(this, new CheckConnectInfo()).awaitOnAnyThread(ConstantKt.DEFAULT_REQUEST_TIMEOUT, TimeUnit.MILLISECONDS)).getStatus();
        if (status.isSuccess()) {
            this.p = System.currentTimeMillis();
            return true;
        }
        int statusCode = status.getStatusCode();
        r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(statusCode, "isConnected is false, statuscode:", "HuaweiApiClientImpl");
    ...
    public boolean setSubAppInfo(SubAppInfo subAppInfo) {
        ...
        if (subAppID.equals(appId)) {
            HMSLog.e("HuaweiApiClientImpl", "subAppId is host appid");
            return false;
        }
        this.f29o = new SubAppInfo(subAppInfo);
        return true;
    }
    ...
    private void h() {
        ...
        this.x.sendEmptyMessageDelayed(2, DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    }
    ...
    private void b(int i) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            r8lambdaLssewuUnwz__zuwPAhaX4NMGewA.RemoteActionCompatParcelizer(i, "connect 2.0 fail: ", "HuaweiApiClientImpl");
        }
