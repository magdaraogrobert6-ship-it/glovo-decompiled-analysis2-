...
public abstract class HuaweiApiAvailability {
    ...
    public abstract setShouldUseDispatchDrawui checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract setShouldUseDispatchDrawui checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract setShouldUseDispatchDrawui getHuaweiServicesReady(Activity activity);
