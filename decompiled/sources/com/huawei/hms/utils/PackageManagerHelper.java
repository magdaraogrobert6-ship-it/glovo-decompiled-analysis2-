...
public class PackageManagerHelper {
    ...
    public boolean isPackageFreshInstall(String str) {
        try {
            PackageInfo packageInfo = this.a.getPackageInfo(str, Fields.SpotShadowColor);
    ...
    public String getApplicationName(String str) {
        try {
            return this.a.getApplicationLabel(this.a.getApplicationInfo(str, Fields.SpotShadowColor)).toString();
        } catch (AndroidException | RuntimeException unused) {
    ...
    public boolean verifyPackageArchive(String str, String str2, String str3) {
        ...
        try {
            ...
            m1$$ExternalSyntheticOutline0.m(e, new StringBuilder("getPackageArchiveInfo Exception. "), "PackageManagerHelper");
    ...
    public PackageStates getPackageStates(String str) {
        ...
        try {
            return this.a.getApplicationInfo(str, Fields.SpotShadowColor).enabled ? PackageStates.ENABLED : PackageStates.DISABLED;
        } catch (AndroidException | RuntimeException unused) {
