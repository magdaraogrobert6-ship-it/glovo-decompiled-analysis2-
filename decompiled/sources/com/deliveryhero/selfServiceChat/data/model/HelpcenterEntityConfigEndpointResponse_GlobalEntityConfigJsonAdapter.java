...
public final class HelpcenterEntityConfigEndpointResponse_GlobalEntityConfigJsonAdapter extends JsonAdapter {
    ...
    public final void toJson(JsonWriter jsonWriter, Object obj) {
        ...
        String str = globalEntityConfig.IconCompatParcelizer;
        JsonAdapter jsonAdapter = this.RemoteActionCompatParcelizer;
        jsonAdapter.toJson(jsonWriter, str);
        jsonWriter.IconCompatParcelizer("self_service_region");
        jsonAdapter.toJson(jsonWriter, globalEntityConfig.read);
        jsonWriter.IconCompatParcelizer("register_device_token_for_p2p_chat");
        this.serializer.toJson(jsonWriter, Boolean.valueOf(globalEntityConfig.RemoteActionCompatParcelizer));
    ...
    public HelpcenterEntityConfigEndpointResponse_GlobalEntityConfigJsonAdapter(getRUNTIME_MEMORY_IMAGE_LOADER_USAGE_QUOTIENTannotations getruntime_memory_image_loader_usage_quotientannotations) {
        ...
        this.read = getLocalBitmap.RemoteActionCompatParcelizer("global_entity_id", "self_service_region", "register_device_token_for_p2p_chat");
        ItemTouchHelperAdapter itemTouchHelperAdapter = ItemTouchHelperAdapter.serializer;
        this.RemoteActionCompatParcelizer = getruntime_memory_image_loader_usage_quotientannotations.read(String.class, itemTouchHelperAdapter, "globalEntityId");
        this.serializer = getruntime_memory_image_loader_usage_quotientannotations.read(Boolean.TYPE, itemTouchHelperAdapter, "registerDeviceTokenForP2PChat");
    }
    ...
    public final Object fromJson(getDisplayHeightAndWidthPixels getdisplayheightandwidthpixels) {
        ...
        while (getdisplayheightandwidthpixels.MediaBrowserCompatMediaItem()) {
            ...
            if (iSerializer != -1) {
                ...
                } else if (iSerializer == 2 && (bool = (Boolean) this.serializer.fromJson(getdisplayheightandwidthpixels)) == null) {
