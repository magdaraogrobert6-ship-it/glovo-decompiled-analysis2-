...
public final class HelpcenterInitBasicRequestBodyJsonAdapter extends JsonAdapter {
    ...
    public final void toJson(JsonWriter jsonWriter, Object obj) {
        ...
        jsonWriter.getClass();
        if (helpcenterInitBasicRequestBody == null) {
        ...
        String str = helpcenterInitBasicRequestBody.appVersion;
        JsonAdapter jsonAdapter = this.read;
        jsonAdapter.toJson(jsonWriter, str);
        jsonWriter.IconCompatParcelizer("bridge");
        boolean z = helpcenterInitBasicRequestBody.bridge;
        JsonAdapter jsonAdapter2 = this.IconCompatParcelizer;
        jsonAdapter2.toJson(jsonWriter, Boolean.valueOf(z));
        jsonWriter.IconCompatParcelizer("email");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.email);
        jsonWriter.IconCompatParcelizer("global_entity_id");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.globalEntityId);
        jsonWriter.IconCompatParcelizer("guest");
        jsonAdapter2.toJson(jsonWriter, Boolean.valueOf(helpcenterInitBasicRequestBody.guest));
        jsonWriter.IconCompatParcelizer("locale");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.locale);
        jsonWriter.IconCompatParcelizer("log_country_code");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.logCountryCode);
        jsonWriter.IconCompatParcelizer("name");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.name);
        jsonWriter.IconCompatParcelizer("p2p_chat_token");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.p2pChatToken);
        jsonWriter.IconCompatParcelizer("p2p_chat_type");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.p2pChatType);
        jsonWriter.IconCompatParcelizer("p2p_sdk_version");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.p2pSdkVersion);
        jsonWriter.IconCompatParcelizer("p2p_chat_country");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.p2pChatCountry);
        jsonWriter.IconCompatParcelizer("platform_token");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.platformToken);
        jsonWriter.IconCompatParcelizer("service_type");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.serviceType);
        jsonWriter.IconCompatParcelizer("user_id");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.userId);
        jsonWriter.IconCompatParcelizer("verification_token");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.verificationToken);
        jsonWriter.IconCompatParcelizer("host_perseus_session_id");
        jsonAdapter.toJson(jsonWriter, helpcenterInitBasicRequestBody.hostPerseusSessionId);
        jsonWriter.serializer();
    }

    public HelpcenterInitBasicRequestBodyJsonAdapter(getRUNTIME_MEMORY_IMAGE_LOADER_USAGE_QUOTIENTannotations getruntime_memory_image_loader_usage_quotientannotations) {
        getruntime_memory_image_loader_usage_quotientannotations.getClass();
        this.write = getLocalBitmap.RemoteActionCompatParcelizer("app_version", "bridge", "email", "global_entity_id", "guest", "locale", "log_country_code", "name", "p2p_chat_token", "p2p_chat_type", "p2p_sdk_version", "p2p_chat_country", "platform_token", "service_type", "user_id", "verification_token", "host_perseus_session_id");
        ItemTouchHelperAdapter itemTouchHelperAdapter = ItemTouchHelperAdapter.serializer;
        this.read = getruntime_memory_image_loader_usage_quotientannotations.read(String.class, itemTouchHelperAdapter, "appVersion");
        this.IconCompatParcelizer = getruntime_memory_image_loader_usage_quotientannotations.read(Boolean.TYPE, itemTouchHelperAdapter, "bridge");
    }
    ...
    public final Object fromJson(getDisplayHeightAndWidthPixels getdisplayheightandwidthpixels) {
        ...
        while (true) {
            ...
            if (getdisplayheightandwidthpixels.MediaBrowserCompatMediaItem()) {
                ...
                JsonAdapter jsonAdapter2 = this.read;
                switch (iSerializer) {
                    case -1:
                        ...
                        break;
                    case 0:
                        String str26 = (String) jsonAdapter2.fromJson(getdisplayheightandwidthpixels);
                        if (str26 == null) {
                ...
                if (bool4 != null) {
                    ...
                    if (bool3 != null) {
                        ...
                        if (str15 != null) {
                            return new HelpcenterInitBasicRequestBody(str25, zBooleanValue, str24, str23, zBooleanValue2, str22, str21, str20, str19, str18, str17, str16, str11, str12, str13, str14, str15);
                        }
    ...
    public final String toString() {
        return IconCompatParcelizer.IconCompatParcelizer(52, "GeneratedJsonAdapter(HelpcenterInitBasicRequestBody)");
    }
}
