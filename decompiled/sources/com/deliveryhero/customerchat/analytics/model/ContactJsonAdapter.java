...
public final class ContactJsonAdapter extends JsonAdapter {
    ...
    public ContactJsonAdapter(getRUNTIME_MEMORY_IMAGE_LOADER_USAGE_QUOTIENTannotations getruntime_memory_image_loader_usage_quotientannotations) {
    ...
    public Contact fromJson(getDisplayHeightAndWidthPixels getdisplayheightandwidthpixels) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        Constructor<Contact> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = Contact.class.getDeclaredConstructor(String.class, Map.class, Integer.TYPE, getRemoteBitmaplambda4.IconCompatParcelizer);
        ...
        Contact contactNewInstance = declaredConstructor.newInstance(str, map, Integer.valueOf(i), null);
        contactNewInstance.getClass();
        return contactNewInstance;
    }

    public String toString() {
        return IconCompatParcelizer.IconCompatParcelizer(29, "GeneratedJsonAdapter(Contact)");
    }
    ...
    public void toJson(JsonWriter jsonWriter, Contact contact) {
        ...
        this.stringAdapter.toJson(jsonWriter, contact.getId());
        jsonWriter.IconCompatParcelizer("details");
        this.nullableMapOfStringNullableStringAdapter.toJson(jsonWriter, contact.getDetails());
