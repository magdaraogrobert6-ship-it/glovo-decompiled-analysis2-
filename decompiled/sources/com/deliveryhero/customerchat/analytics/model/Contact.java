...
public final class Contact {
    ...
    public Contact(@getDensityDpi(serializer = "id") String str, @getDensityDpi(serializer = "details") Map<String, String> map) {
        str.getClass();
        this.id = str;
        this.details = map;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!((Boolean) removeNodeAtDepth.RemoteActionCompatParcelizer(getCieXyz.write(), 1803334089, -1803334089, getCieXyz.write(), getCieXyz.write(), new Object[]{this.id, contact.id}, getCieXyz.write())).booleanValue()) {
            return false;
        }
        return ((Boolean) removeNodeAtDepth.RemoteActionCompatParcelizer(getCieXyz.write(), 1803334089, -1803334089, getCieXyz.write(), getCieXyz.write(), new Object[]{this.details, contact.details}, getCieXyz.write())).booleanValue();
    }
    ...
    public final Contact copy(@getDensityDpi(serializer = "id") String str, @getDensityDpi(serializer = "details") Map<String, String> map) {
        str.getClass();
